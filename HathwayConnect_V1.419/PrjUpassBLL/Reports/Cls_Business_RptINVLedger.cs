...
namespace PrjUpassBLL.Reports
{
    public class Cls_Business_RptINVLedger
    {
        public Hashtable GetTransations(Hashtable htAddPlanParams, string username, string catid, string operator_id)
        {
            ...
            {
                dateString += "  dt >=  '" + from + "' ";
                dateStringparty += "  dat_partled_date >=  '" + from + "' ";
                searchParamStr += " <b>Transaction From : </b> " + from;
            }
            if (to != null && to != "")
            {
                dateString += " and dt <=  '" + to + "' ";
                dateStringparty += " and dat_partled_date <=  '" + to + "' ";
            ...
            Cls_Data_RptINVLedger objDataRptAddPlan = new Cls_Data_RptINVLedger();
            Hashtable htResponse = new Hashtable();
            htResponse.Add("htResponse", objDataRptAddPlan.GetTransations(dateString, whereString, username, dateStringparty));
