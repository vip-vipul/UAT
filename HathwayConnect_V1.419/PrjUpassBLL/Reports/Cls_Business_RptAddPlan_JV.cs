...
{
   public class Cls_Business_RptAddPlan_JV
    {
        public Hashtable GetTransations(Hashtable htAddPlanParams, string username, string catid, string operator_id)
        {
            ...
            Cls_Data_RptAddPlan_JV objDataRptAddPlan = new Cls_Data_RptAddPlan_JV();
            Hashtable htResponse = new Hashtable();
            htResponse.Add("htResponse", objDataRptAddPlan.GetTransations(whereString, username));
        ...
        public Hashtable GetTransationsMSO(Hashtable htAddPlanParams, string username, string catid, string operator_id)
        {
            ...
            Cls_Data_RptAddPlan_JV objDataRptAddPlan = new Cls_Data_RptAddPlan_JV();
            Hashtable htResponse = new Hashtable();
            htResponse.Add("htResponse", objDataRptAddPlan.GetTransationsMSO(whereString, username));
            htResponse.Add("ParamStr", searchParamStr);
            return htResponse;
        }
        ...
        public Hashtable GetTransationsU(Hashtable htAddPlanParams1, string username1, string catid1, string operator_id1)
        {
            ...
            Cls_Data_RptAddPlan_JV objDataRptAddPlan = new Cls_Data_RptAddPlan_JV();
            Hashtable htResponse = new Hashtable();
            htResponse.Add("htResponse", objDataRptAddPlan.GetTransationsU(whereString, username1));
            htResponse.Add("ParamStr", searchParamStr);
            return htResponse;
        }
