...
{
    public partial class mstLCOAdminPages : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Master.PageHeading = "LCO Admin";
        ...
        private void BindData()
        {
            try
            {
                ...
                str += " and num_frm_cat in (1,2) and a.num_frm_id=b.num_rights_frmid  ";
                str += " and num_frm_id in (2,15,53) ";
