<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="rptBulkTransactionProc.aspx.cs" Inherits="PrjUpassPl.Reports.rptBulkTransactionProc" %>
                    ...
                    <div id="divtextbox" class="delInfo1" runat="server">
                        <table runat="server" align="center" width="700px" id="tbl1" border="0">
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtUniqueid" runat="server" Width="80%" MaxLength="50"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
