<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="rptExpiry_new.aspx.cs" Inherits="PrjUpassPl.Reports.rptExpiry_new" %>
        ...
        <ContentTemplate>
            <asp:Panel runat="server" ID="pnlSearch">
                ...
                <button onclick="return goBack()"  style="margin-right:5px;margin-top:-15px;"   class="button">Back</button>
                            ...
                            <tr>
                                <td align="center">
                                    Package : &nbsp;<asp:DropDownList ID="ddlPackage" runat="server">
                                        ...
                                        <asp:ListItem Text="Hathway Bouquet" Value="HSP"></asp:ListItem>
                                        <asp:ListItem Text="Broadcaster Bouquet" Value="AD"></asp:ListItem>
                                        <asp:ListItem Text="Ala-Carte" Value="AL"></asp:ListItem>
                                        <asp:ListItem Text="NCF(Excl.NCF 1)" Value="NCF"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                           ...
                           <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtsearchpara" runat="server" Style="resize: none;" Width="180px"
                                        onkeydown="SetContextKey()" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <table width="100%">
                    ...
                    <table style="width: 80%;" runat="server" id="tblDetails" visible="false">
                        <tr>
                            <td align="center">
                               <table width="70%" style="border: 1px solid black; border-collapse: collapse; ">
                                <tr style="border: 1px solid black; border-collapse: collapse; " runat="server" id="trLCO" visible="false">
                                <td style="border: 1px solid black; border-collapse: collapse; width: 180px;" align="center" >  
                              <b> <asp:Label ID="lblpro" runat="server" Text="LCO Top Up Required : " ></asp:Label></b>
                               </td>
                               <td style="border: 1px solid black; border-collapse: collapse; width: 175px;" align="center" > 
                                <b><asp:Label ID="lblResultCount" runat="server"></asp:Label></b>
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; width: 175px;" align="center" > 
                                <asp:Button runat="server" ID="btnGenerateExcel" Text="Generate Excel" CssClass="button"
                                    UseSubmitBehavior="false" OnClick="btnGenerateExcel_Click"  Width="120px" />
                                </td>
                                </tr>
                                 <tr style="border: 1px solid black; border-collapse: collapse; " runat="server" id="trCust" visible="false">
                                <td style="border: 1px solid black; border-collapse: collapse; width: 180px;" align="center" >  
                              <b> <asp:Label ID="lblcustpro1" runat="server" Text="Collection from customer : "></asp:Label>
                              <br />
                              <asp:Label ID="lblcustpro2" runat="server" Text="(Customer MRP)" ></asp:Label>
                              </b>
                               </td>
                               <td style="border: 1px solid black; border-collapse: collapse; width: 175px;" align="center" > 
                                <b><asp:Label ID="lblCustCount" runat="server"></asp:Label></b>
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; width: 175px;" align="center" > 
                        ...
                        OnSorting="grdLcoPartyLedger_Sorting"--%>
                                        ...
                                        Visible="false"></asp:Label><asp:Label ID="lblolconame" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"lco_name")%>'
                                            ...
                                            <asp:BoundField HeaderText="Renewal Status" DataField="renewflagstatus" HeaderStyle-HorizontalAlign="Center"
                                                Visible="true" ItemStyle-HorizontalAlign="Left" />
                                          <%--  <asp:BoundField HeaderText="LCO Price" DataField="renewflagstatus" HeaderStyle-HorizontalAlign="Center"
                                                Visible="true" ItemStyle-HorizontalAlign="Left" />--%>
                                            <asp:TemplateField HeaderText="LCO Price">
                                                       <ItemTemplate><asp:Label ID="lblTotalPrice" runat="server" Text='<%#Eval("lco_price")%>'>
