<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="frmCancelPlans.aspx.cs" Inherits="PrjUpassPl.Transaction.frmCancelPlans" %>
    ...
    <script type="text/javascript">
        ...
        function testc(id) {
            ...
            if (TotalTrueRows == 20) {
                ...
                alert("Add Plan Max Selection 20 only.");
            }
           ...
           function ChkcountBulkCancelStatus(action, id) {
               ...
               if (id == "B") {
                   if ($(action).prop('checked') == true) {
                       $("#MasterBody_grdBulkCancel tr").each(function () {
                           var this_row = $(this);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterBody" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
        <asp:HiddenField ID="hdnButtonValue" runat="server" Value="Sachin123" />
            <div class="maindive">
                <div class="griddiv">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 285px;">
                                                <asp:RadioButtonList ID="rdoSearchParamType" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem  Value="0">VC/Mac ID/VM</asp:ListItem>
                                                    <asp:ListItem Selected="True" Value="1">Account No</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                            <td style="width: 95px;">
                            ...
                            <div class="tabody">
                                    ...
                                    <table width="100%" id="tbl" runat="server">
                                        ...
                                        <tr id="trServiceStatus" runat="server">
                                            ...
                                            <td align="left">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Button ID= "btnBulkCancel" runat="server" Text="Cancel All" OnClick="btnBulkCancel_Click"  />
                                ...
                                <div id="planDetail" runat="server" visible="false">
                                        ...
                                        <div class="delInfo">
                                            <table style="border-collapse: collapse" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Button ID="btnAutoRenewal" runat="server" Text="Auto Renew" OnClick="btnAutoRenewal_Click" Visible="false" />&nbsp;
                                                        <asp:Button ID="btnOpenAddPopup" runat="server" Text="Add Plan" OnClick="btnOpenAddPopup_Click" Visible="false" />
                                                        &nbsp;<asp:Button ID="btnOpenRenewNowPopup" runat="server" Text="Renew Now" Visible="false"
                                                            OnClick="btnOpenRenewNowPopup_Click" />&nbsp;&nbsp;
                                                        <asp:CheckBox ID="Challrenew" runat="server" onclick="checking(this);" />
                                                        <asp:Label runat="server" ID="allrenewal" Text="All ADD"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                    ...
                                                    <td align="left" width="100%" colspan="2">
                                                        <div class="plan_scroller">
                                                            <asp:GridView ID="grdBasicPlanDetails" CssClass="Grid" runat="server" AutoGenerateColumns="false"
                                                                OnRowDataBound="grdBasicPlanDetails_RowDataBound" RowStyle-ForeColor="Red">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="ADD" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="cbBasicrenew" runat="server" AutoPostBack="false" onclick="Chkcount(1)" Enabled="false" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-anchor-bottom-right dropdown-has-anchor" id='<%# "basic"+Container.DataItemIndex+1 %>'>
                                                                                <ul>
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="lnkaddplanbaseexpired" runat="server" Text="ADD" Visible="false" OnClick="lnkaddplanbaseexpired_Click"
                                                                                            Width="110" /></a></li>
                                                                                    <li><a href="#">
                                                                                    ...
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="lnkBCancel" runat="server" Text="CANCEL" OnClick="lnkBCancel_Click"
                                                                                            Width="110" /></a></li>
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="lnkBChange" runat="server" Text="CHANGE" Visible="false" OnClick="lnkBChange_Click"
                                                                                            Width="110" /></a></li>
                                                                                    <li><a href="#">
                                                    ...
                                                    <td colspan="2" align="left">
                                                                        <div class="plan_scroller">
                                                                            <asp:GridView ID="Grdhathwayspecial" CssClass="Grid" Width="100%" runat="server"
                                                                                AutoGenerateColumns="false" OnRowDataBound="Grdhathwayspecial_RowDataBound" RowStyle-ForeColor="Red">
                                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField HeaderText="BC Share" DataField="BD_PRICE" ItemStyle-HorizontalAlign="Left"
                                                                        ...
                                                                        ItemStyle-Width="80" />
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="ADD" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="cbAddonrenew" runat="server" AutoPostBack="false" onclick="Chkcount(this)" Enabled="false" />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:BoundField HeaderText="Status" DataField="PLAN_STATUS" ItemStyle-HorizontalAlign="Left"
                                                                                        ItemStyle-Width="60" />
                                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <div class="dropdown-menu dropdown-anchor-bottom-right dropdown-has-anchor" id='<%# "HathSpecial"+Container.DataItemIndex+1 %>'>
                                                                                                ...
                                                                                                <li><a href="#">
                                                                                                        <asp:Button ID="lnkHSPaddplanbaseexpired" runat="server" Text="ADD" Visible="false" OnClick="lnkHSPaddplanbaseexpired_Click"
                                                                                                            Width="110" /></a></li>
                                                                                                    <li><a href="#">
                                                                    ...
                                                                    <Content>
                                                                        <div class="plan_scroller">
                                                                            <asp:GridView ID="grdAddOnPlan" CssClass="Grid" Width="100%" runat="server" AutoGenerateColumns="false"
                                                                                OnRowDataBound="grdAddOnPlan_RowDataBound" RowStyle-ForeColor="Red">
                                                                                <Columns>
                                                                                    <asp:BoundField HeaderText="Plan Name" DataField="PLAN_NAME" ItemStyle-Width="350px"
                                                                                        ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="SD" DataField="SD_Count" ItemStyle-HorizontalAlign="Left"
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <div class="dropdown-menu dropdown-anchor-bottom-right dropdown-has-anchor" id='<%# "addon"+Container.DataItemIndex+1 %>'>
                                                                                                <ul>
                                                                                                <li><a href="#">
                                                                                        <asp:Button ID="lnkADaddplanbaseexpired" runat="server" Text="ADD" Visible="false" OnClick="lnkADaddplanbaseexpired_Click"
                                                                                            Width="110" /></a></li>
                                                                                                    <li><a href="#">
                                                                                                        <asp:Button ID="lnkADRenew" runat="server" Text="RENEW" OnClick="lnkADRenew_Click"
                                                                                                            Width="110" /></a></li>
                                                                    ...
                                                                    <Content>
                                                                        <div class="plan_scroller">
                                                                            <asp:GridView ID="grdAddOnPlanReg" CssClass="Grid" Width="100%" runat="server" AutoGenerateColumns="false"
                                                                                OnRowDataBound="grdAddOnPlanReg_RowDataBound" RowStyle-ForeColor="Red">
                                                                                <Columns>
                                                                                    <asp:BoundField HeaderText="Plan Name" DataField="PLAN_NAME" ItemStyle-Width="350px"
                                                                                        ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="SD" DataField="SD_Count" ItemStyle-HorizontalAlign="Left"
                                                                    ...
                                                                    <Content>
                                                                        <div class="plan_scroller">
                                                                            <asp:GridView ID="grdCartefree" CssClass="Grid" Width="100%" runat="server" AutoGenerateColumns="false"
                                                                                OnRowDataBound="grdCartefree_RowDataBound" RowStyle-ForeColor="Red">
                                                                                <Columns>
                                                                                    <asp:BoundField HeaderText="Plan Name" DataField="PLAN_NAME" ItemStyle-Width="350px"
                                                                                        ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="SD" DataField="SD_Count" ItemStyle-HorizontalAlign="Left"
                                                                    ...
                                                                    <Content>
                                                                        <div class="plan_scroller">
                                                                            <asp:GridView ID="grdCarte" CssClass="Grid" Width="100%" runat="server" AutoGenerateColumns="false"
                                                                                OnRowDataBound="grdCarte_RowDataBound" RowStyle-ForeColor="Red">
                                                                                <Columns>
                                                                                    <asp:BoundField HeaderText="Plan Name" DataField="PLAN_NAME" ItemStyle-Width="350px"
                                                                                        ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="SD" DataField="SD_Count" ItemStyle-HorizontalAlign="Left"
                                                                        ...
                                                                        ItemStyle-Width="80" />
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Auto Renew" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="lblAutorenew" Text="Off" runat="server"></asp:Label>
                                                                                            <asp:CheckBox ID="cbAlaAutorenew" Style="visibility: hidden" Enabled="false" runat="server"
                                                                                                onclick="CheckOne(1)" AutoPostBack="true" OnCheckedChanged="cbAlaAutorenew_Clicked" />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="ADD" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="chkalRenew" runat="server" AutoPostBack="false" onclick="testc(this)" />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:BoundField HeaderText="Status" DataField="PLAN_STATUS" ItemStyle-HorizontalAlign="Left"
                                                                                        ItemStyle-Width="60" />
                                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <div class="dropdown-menu dropdown-anchor-bottom-right dropdown-has-anchor" id='<%# "alacarte"+Container.DataItemIndex+1 %>'>
                                                                                                <ul>
                                                                                                <li><a href="#">
                                                                                        <asp:Button ID="lnkALaddplanbaseexpired" runat="server" Text="ADD" Visible="false" OnClick="lnkALaddplanbaseexpired_Click"
                                                                                            Width="110" /></a></li>
                                                                                                    <li><a href="#">
                                                                                                        <asp:Button ID="lbALRenewal" runat="server" Text="RENEW" OnClick="lnkALRenew_Click"
                                                                                                            Width="110" /></a></li>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnRenSubmit" runat="server" Text="submit" OnClick="btnRenSubmit_Click1"
                    ...
                    <asp:Panel ID="pnlConfirmation" runat="server" CssClass="Popup" Style="width: 500px;
                        ...
                        <center>
                            ...
                            <table width="85%" ID="tblRenew" runat="server">
                                <tr>
                                            ...
                                            <asp:GridView ID="GrdAllRenewConfirm" CssClass="Grid" runat="server" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="LCO Price" DataField="LCO_PRICE" ItemStyle-HorizontalAlign="Right"
                                                        ItemStyle-Width="100" FooterStyle-HorizontalAlign="Right" Visible="false" />
                                                        <asp:BoundField HeaderText="Activation" DataField="Activation" ItemStyle-HorizontalAlign="Right"
                                                        FooterStyle-HorizontalAlign="Right" ItemStyle-Width="115" />
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    <asp:Button ID="Button16" runat="server" CssClass="button" Text="OK" Visible="true"
                                        Width="100px" OnClick="btnCancelAll_Click" />&nbsp; &nbsp;&nbsp;
            ...
            <asp:GridView ID="GrdchangePlan" CssClass="Grid" runat="server" AutoGenerateColumns="false" ShowFooter="false">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Select" ItemStyle-Width="50">
                                                                        <ItemTemplate>
                                                                            <asp:RadioButton ID="rbtnchangeplanselect" runat="server" onclick = "RadioCheck(this);"/>
                                                                            <asp:HiddenField ID="hdnplanaddconfPlanPoid" runat="server" Value='<%# Eval("plan_poid").ToString()%>' />
                                                                            <asp:HiddenField ID="hdnplanaddconfDealPoid" runat="server" Value='<%# Eval("DEAL_POID").ToString()%>' />
                ...
                <asp:Panel ID="pnlFinalConfirm" runat="server" CssClass="Popup" Style="width: 500px;
                    display: none; height: auto;">
                    <%-- display: none; --%>
                    <center>
                        <br />
