<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transhwaybilldetails.aspx.cs" MasterPageFile="~/MasterPage.Master" Inherits="PrjUpassPl.Transaction.transhwaybilldetails" %>
                                    ...
                                    <td align="center">
                                        <div class="delInfo">
                                            ...
                                            <td style="padding-left: 35px" align="right">
                                                    <asp:Label ID="lblccno" runat="server" Text="Account No"></asp:Label>                                                    
                                                    </td>
                                             <td>
                                             <asp:Label ID="Label1" runat="server" Text=":"></asp:Label>                                                    
                                                            </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtaccno" runat="server" MaxLength="30" Width="90px"></asp:TextBox>
                                                ...
                                                <tr id="Trbillno" runat="server">                                               
                                                    ...
                                                    <td align="left">
                                                        <asp:DropDownList ID="ddlbillno" AutoPostBack="True" runat="server" Height="19px"
                                                            ...
                                                            onselectedindexchanged="ddlbillno_SelectedIndexChanged" Visible="False">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
