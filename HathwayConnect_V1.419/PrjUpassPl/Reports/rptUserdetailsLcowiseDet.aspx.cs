...
{
    public partial class rptUserdetailsLcowiseDet : System.Web.UI.Page
    {
        decimal usercount = 0;
        protected void Page_Load(object sender, EventArgs e)
        {
            Master.PageHeading = "User Details (Lco wise)";
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                try
                {
                    ...
                    String strheader = "Sr.No." + Convert.ToChar(9) + "User Id" + Convert.ToChar(9) + "User Name" + Convert.ToChar(9)
                        ...
                        + "User Type" + Convert.ToChar(9) + "Email" + Convert.ToChar(9) + "Mobile Number" + Convert.ToChar(9) + "Account number" + Convert.ToChar(9)
