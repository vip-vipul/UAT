...
{
    public partial class rptAddPlanTransSelfLCO : System.Web.UI.Page
    {
        decimal amt = 0;
        decimal cnt = 0;
        ...
        {
            //Response.Redirect("../Reports/rptAddPlanTransSelfDET.aspx?showall=1");
            string username;
        ...
        protected void grdAddPlanSearch_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("LcoName1"))
            {
                ...
                Response.Redirect("../Reports/rptAddPlanTransSelfUSER.aspx");
            }
        }
