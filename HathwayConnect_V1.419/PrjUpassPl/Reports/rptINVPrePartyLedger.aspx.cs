...
{
    public partial class rptINVPrePartyLedger : System.Web.UI.Page
    {
        decimal crlimit = 0;
        decimal opnbal = 0;
        decimal debit = 0;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (catid == "3")
            {
                ...
                Response.Redirect("../Reports/rptINVPrePartyLedgerDET.aspx?showall=1");
            }
        ...
        {
            Response.Redirect("../Reports/rptINVPrePartyLedgerDET.aspx?showall=0");
        }
