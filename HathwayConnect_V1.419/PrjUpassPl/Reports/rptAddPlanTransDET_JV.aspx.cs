...
{
    public partial class rptAddPlanTransDET_JV : System.Web.UI.Page
    {
        decimal amtdd = 0;
        decimal bal = 0;
                ...
                try
                {
                    ...
                    while (j < dt.Rows.Count)
                    {
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            + dt.Rows[i]["broad_price"].ToString() + ","
                            + dt.Rows[i]["jv_price"].ToString() + ","
                            + dt.Rows[i]["jv_balance"].ToString();
        ...
        protected void btn_genExcel_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["searched_trans"] != null)
            {
                ...
                try
                {
                    ...
                    + "Broadcaster Price" + Convert.ToChar(9)
                    +"JV Price" + Convert.ToChar(9)
                    +"JV Balance" + Convert.ToChar(9);
                    ...
                    while (j < dt.Rows.Count)
                    {
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            + dt.Rows[i]["LCOMRP"].ToString() + Convert.ToChar(9)
                            ...
                            + dt.Rows[i]["SFLAG"].ToString() + Convert.ToChar(9)
                             + dt.Rows[i]["LSHARE"].ToString() + Convert.ToChar(9)
                              ...
                              + dt.Rows[i]["discount"].ToString() + Convert.ToChar(9)
                               + dt.Rows[i]["broad_price"].ToString() + Convert.ToChar(9)
                            + dt.Rows[i]["jv_price"].ToString() + Convert.ToChar(9)
                            + dt.Rows[i]["jv_balance"].ToString() + Convert.ToChar(9);
                            sw.WriteLine(strrow);
                        }
                    }
                    sw.Flush();
