...
{
    public partial class frmMeddleBulkTransaction : System.Web.UI.Page
    {
        static int intNum;
        ...
        protected void SearchbindData(string Unique_id)
        {
            ...
            dt = objTran.GetEcafDetails(username, operator_id, catid, Unique_id);
        ...
        protected void binddata(string upload_id, int IntBulkStatus)
        {
            ...
            Cls_Business_RptBulkTransProces objTran = new Cls_Business_RptBulkTransProces();
            dt = objTran.GetBulkEcafStatusDetails(username, upload_id, IntBulkStatus);
