<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="rptAddPlanTransSelfMSO.aspx.cs" Inherits="PrjUpassPl.Reports.rptAddPlanTransSelfMSO" %>
                        ...
                        <table width="100%">
                            <tr>
                                <td colspan="4" style="padding-left: 100px;">
                                    <asp:Label ID="lbldateset" runat="server" Text="From date & To date should be same Month !"
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    <asp:Button runat="server" ID="btnSubmit" Text="Search" CssClass="button" OnClick="btnSubmit_Click"
                                        OnClientClick="return checkvalid();" />
                                    <asp:Button runat="server" ID="Button1" Text="Reset" CssClass="button" OnClick="btnreset_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
