<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="rptINVPrePartyLedgerDET.aspx.cs" Inherits="PrjUpassPl.Reports.rptINVPrePartyLedgerDET" %>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="width: 100px">
                                <asp:Button runat="server" ID="btn_genExl" Text="Generate Excel" CssClass="button" Width="120px"
