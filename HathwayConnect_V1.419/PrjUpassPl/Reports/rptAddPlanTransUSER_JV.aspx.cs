...
{
    public partial class rptAddPlanTransUSER_JV : System.Web.UI.Page
    {
        decimal amt = 0;
        decimal cnt = 0;
        ...
        protected void grdTransUserDet_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("UserName1"))
            {
                ...
                Response.Redirect("../Reports/rptAddPlanTransDET_JV.aspx?showall=U");
            }
        }
        ...
        protected void btnAll_Click(object sender, EventArgs e)
        {
            ...
            {*/
            Response.Redirect("../Reports/rptAddPlanTransDET_JV.aspx?lcoid='" + Session["lcoid"].ToString() + "'&lconame='" + Session["lconame"].ToString() + "'&showall=2");
            //}
        }
