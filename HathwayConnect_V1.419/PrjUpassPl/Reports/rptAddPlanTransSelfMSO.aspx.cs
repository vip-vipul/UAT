...
{
    public partial class rptAddPlanTransSelfMSO : System.Web.UI.Page
    {
        decimal amt = 0;
        decimal cnt = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.PageHeading = "Self Transaction Report";
            Session["RightsKey"] = "N";
        ...
        private Hashtable getAddPlanParamsData()
        {
            ...
            if (System.DateTime.Now.Month != fromDt.Month)
            {
                string strMonth = txtFrom.Text.Split('-')[1];
                tablemonth = "_" + strMonth + Convert.ToString(fromDt.Year).Replace("20", "");
            }
            else
            {
                tablemonth = "";
            ...
            htSearchParams.Add("tablemonth", tablemonth);
            Session["tablemonth"] = tablemonth;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(from) && !String.IsNullOrEmpty(to))
            {
                fromDt = new DateTime();
                toDt = new DateTime();
                NonNTODate = new DateTime();
                fromDt = DateTime.ParseExact(from, "dd-MMM-yyyy", null);
                toDt = DateTime.ParseExact(to, "dd-MMM-yyyy", null);
                NonNTODate = DateTime.ParseExact("31-Jan-2019", "dd-MMM-yyyy", null);
                ...
                else if (fromDt <= NonNTODate)
                {
                    lblSearchMsg.Text = "Kindly use Non NTO Transaction Report for selected Period";
                    return;
                }
                else if (Convert.ToString(fromDt.Month) != Convert.ToString(toDt.Month))
                {
                    lblSearchMsg.Text = "From date To date should be same Month !";
                    return;
                }
            ...
            if (catid == "3")
            {
                ...
                Session["lconame"] = "All";
                Session["showall"] = "1";
                Response.Redirect("../Reports/rptAddPlanTransSelfUSER.aspx");//?lcoid=" + operator_id.ToString());// + "'" + "lcoid=" + operator_id.ToString());              
            }
            if (catid == "11")
            {
                ...
                Session["msoname"] = "All";
                Session["showall"] = "1";
                Response.Redirect("../Reports/rptAddPlanTransSelfLCO.aspx");
            }
            if (catid == "2")
            {
                Session["msoid"] = operator_id.ToString();
        ...
        {
            //Response.Redirect("../Reports/rptAddPlanTransSelfDET.aspx?showall=0");
