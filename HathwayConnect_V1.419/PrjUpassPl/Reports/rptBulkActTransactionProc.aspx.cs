...
{
    public partial class rptBulkActTransactionProc : System.Web.UI.Page
    {
        static int intNum;
        protected void Page_Load(object sender, EventArgs e)
        {
            Session["RightsKey"] = "N";
            Master.PageHeading = "Bulk Act Upload Process";
            if (!IsPostBack)
            {
        ...
        protected void SearchbindData(string Unique_id)
        {
            ...
            Cls_Business_RptBulkActTransProces objTran = new Cls_Business_RptBulkActTransProces();
