<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptbulkchangetransproc.aspx.cs" Inherits="PrjUpassPl.Reports.rptbulkchangetransproc" MasterPageFile="~/MasterPage.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function ShowPopup() {
            ...
            var myVar = setInterval(function () { ShowModalPopup() }, 45000);
        }
                        ...
                        <div id="DivGried" runat="server">
                            ...
                            <asp:GridView runat="server" ID="grdBulkstatus" CssClass="Grid" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="customer account" DataField="customer_id" HeaderStyle-HorizontalAlign="Center"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" />
