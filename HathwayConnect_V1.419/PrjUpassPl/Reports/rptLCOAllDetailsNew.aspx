<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="rptLCOAllDetailsNew.aspx.cs" Inherits="PrjUpassPl.Reports.rptLCOAllDetailsNew" %>
            ...
            <asp:Panel runat="server" ID="pnlSearch">
                ...
                <div runat="server" id="div1">
                    <table>
                        <tr>
                            <td>
                                <asp:Label ID="Label43" runat="server" Text="LCO"></asp:Label>
                        ...
                        <tr>
                            <td colspan="4">
                                <asp:Label ID="Label45" ForeColor="Red" runat="server" Text=""></asp:Label>
                               
                            </td>
                        </tr>
                    </table>
                </div>
                    <div runat="server" id="divLcoAllSearch" style="padding: 100px; height: 210px; margin-top: -100px; margin-left: -80px; 
                        margin-right: -80px">
