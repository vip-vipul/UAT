<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="RptSTBTransfer.aspx.cs" Inherits="PrjUpassPl.Reports.RptSTBTransfer" %>
                        ...
                        <div style="overflow: scroll; width: 100%" id="DivMainContent">
                            <asp:GridView runat="server" ID="grdDetail" CssClass="Grid" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="STB No" DataField="stb" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="100px" />
                                    <asp:BoundField HeaderText="LCO Code" DataField="var_stbtransfer_lcocode" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="Amount" DataField="num_stbtransfer_stbamount" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="right" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="Status" DataField="status" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="Admin Remark" DataField="adminremark" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="Admin Approval By" DataField="adminapprovlby" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="Admin Approval Date" DataField="adminappdate" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="LCO Remark" DataField="lcoremark" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="LCO Approval By" DataField="lcoapprovedby" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
                                    <asp:BoundField HeaderText="LCO Approval date" DataField="lcoapproveddate" HeaderStyle-HorizontalAlign="Left"
                                        Visible="true" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="150px" />
