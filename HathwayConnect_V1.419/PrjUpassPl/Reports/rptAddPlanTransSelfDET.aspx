<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="rptAddPlanTransSelfDET.aspx.cs" Inherits="PrjUpassPl.Reports.rptAddPlanTransSelfDET" %>
                        ...
                        <asp:GridView runat="server" ID="grdTransDet" CssClass="Grid"  AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="MRP" DataField="custprice" HeaderStyle-HorizontalAlign="Center"
                                    ItemStyle-HorizontalAlign="left" />
                                    <asp:BoundField HeaderText="LCO MRP" DataField="netlcoprice" HeaderStyle-HorizontalAlign="Center"
