<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="TransHwayBulkDiscount.aspx.cs" Inherits="PrjUpassPl.Transaction.TransHwayBulkDiscount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterBody" runat="server">
    ...
    <div class="maindive">
    <h3>
        <asp:Label runat="server" ID="Label1" Text="Discount File Upload" ForeColor="Black"></asp:Label>
    </h3>
    <div class="delInfo">
        <asp:FileUpload ID="fupData" runat="server" />
        &nbsp
        <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" />
         &nbsp;<a href="../GeneratedFiles/DemoExcel/Bulk_Discount_Format.xlsx" id="bulktransaction" runat="server">Download Template</a>
    </div>
    <br />
    <div class="delInfo" id="Operation" runat="server" visible="true" style="margin-top: 10px; text-align: left; 
            ...
            <center>
                <h2>
                    Steps to use the bulk upload file for bulk discount.</h2>
            </center>
