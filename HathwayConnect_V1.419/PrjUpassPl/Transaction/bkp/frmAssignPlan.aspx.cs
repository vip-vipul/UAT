...
namespace PrjUpassPl.Transaction
{
    public partial class frmAssignPlan : System.Web.UI.Page
    {
        ...
        double GSTValue = Convert.ToDouble(ConfigurationSettings.AppSettings["GSTValue"].ToString().Trim());
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dtBasicPlans.Columns.Add(new DataColumn("CUST_PRICE1"));
            ...
            dtAddonPlans.Columns.Add(new DataColumn("CUST_PRICE1"));
            ...
            dtAddonPlansreg.Columns.Add(new DataColumn("CUST_PRICE1"));
            ...
            dtAlacartePlans.Columns.Add(new DataColumn("CUST_PRICE1"));
            ...
            dthathwayspecial.Columns.Add(new DataColumn("CUST_PRICE1"));
            ...
            dtAlacartePlansFree.Columns.Add(new DataColumn("CUST_PRICE1"));
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["username"] != null && Session["operator_id"] != null)
                {
                    ...
                    String dasarea = "";
                    String operid = "";
                    pl1.GetUserCity(Session["username"].ToString(), out city, out dasarea, out operid);
        ...
        protected string dataTableBuilder(DataTable dt, string[] arr_data, string plan_type_flag)
        {
            ...
            foreach (string plan_data in arr_data)
            {
                ...
                {
                    Double Plan_DiscPrice = 0;
                    if (ViewState["discounttype"].ToString() != "P")
                    {

                        // tempDr["DISCOUNT"] = "Rs. " + Convert.ToDouble(ViewState["DiscountAmount"].ToString()).ToString();
                        Plan_DiscPrice = Convert.ToDouble(plan_details_arr[2]) - Convert.ToDouble(ViewState["DiscountAmount"]);
                    }
                    else
                    {
                        Double Plan_Disc = Convert.ToDouble(plan_details_arr[2]) * Convert.ToDouble(ViewState["DiscountAmount"]) / 100;
                        Plan_DiscPrice = Convert.ToDouble(plan_details_arr[2]) - Plan_Disc;
                        tempDr["DISCOUNT"] = Convert.ToDouble(ViewState["DiscountAmount"].ToString()).ToString() + " %";
                    }
                    // Double Plan_DiscPrice = Convert.ToDouble(plan_details_arr[2]) - Convert.ToDouble(ViewState["DiscountAmount"]);
                    tempDr["CUST_PRICE1"] = Math.Round(Plan_DiscPrice + Plan_DiscPrice * GSTValue);
                    ...
                    // Double LessDisMRP    =Convert.ToDouble(plan_custprice) - Convert.ToDouble( ViewState["DiscountAmount"].ToString());
                    //tempDr["CUST_PRICE1"] = Math.Round( LessDisMRP+LessDisMRP*GSTValue);
                }
                else
                {
                    tempDr["CUST_PRICE1"] = Math.Round(Convert.ToDouble(plan_details_arr[2]) * GSTValue);
                }
        ...
        protected void bindAllGrids(string service_str)
        {
            try
            {
                ...
                string service_data = obj.getServiceDataBL(Session["username"].ToString(), city, all_plan_string, lblCustNo.Text);
                ...
                if (service_data_arr[0] != "9999")
                {
                    ...
                    if (service_data_arr[1] != "" || service_data_arr[1] != null)
                    {
                        msgboxstr(service_data_arr[1].ToString());
                    }
                    else
                    {
                ...
                for (int i = 0; i < grdCartefree.Rows.Count; i++)
                {
                    ...
                    Button lbALCancel = (Button)grdCartefree.Rows[i].Cells[8].FindControl("lbALCancel");
                ...
                for (int i = 0; i < grdBasicPlanDetails.Rows.Count; i++)
                {
                    ...
                    if (grdBasicPlanDetails.Rows[i].Cells[9].Text.ToString().ToString().ToUpper() == "EXPIRED")
                    {
                        ...
                        grdBasicPlanDetails.Rows[i].Cells[10].ForeColor = System.Drawing.Color.Red;
                ...
                try
                {
                    ...
                    {
                        DateTime dtexpiry = Convert.ToDateTime(dtBasicPlans.Rows[0]["EXPIRY"]);

                        if (dtexpiry < DateTime.Now && dtBasicPlans.Rows[0]["EXPIRY"].ToString() != "31-DEC-69" && dtBasicPlans.Rows[0]["EXPIRY"].ToString() != "30-DEC-30")
                        {
                            // btnOpenAddPopup.Visible = false;
                            radPlanAD.Enabled = false;
                            radPlanAL.Enabled = false;
                ...
                if (dthathwayspecial.Rows.Count == 0)
                {
                    ...
                    hathspecialAccordion.Visible = false;
                }
                else
                {
                    dynamiclink.Visible = true;
                    ...
                    hathspecialAccordion.Visible = true;
                    hathspecialAccordion.SelectedIndex = -1;
                }
                ...
                else
                {
                    ...
                    lblAddonPlanReg.Visible = true;
                    AddonAccordionReg.Visible = true;
                ...
                if (lblBasicPlan.Visible == false && lblAddonPlan.Visible == false && lblAlacartePlan.Visible == false)
                {
        ...
        protected void lnkADRenew_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hdnCustMRP = (HiddenField)grdAddOnPlan.FindControl("hdnADCustMRP");
            ...
            htData["custMRP"] = hdnCustMRP.Value;
        ...
        protected void lnkALRenew_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hdnCustMRP = (HiddenField)grdCarte.FindControl("hdnALCustMRP");
        ...
        protected void lnkALCancel_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hdnPlanName = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALPlanName");
            // HiddenField hdnPlanType = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALPlanType");
            HiddenField hdnPlanPoid = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALPlanPoid");
            HiddenField hdnDealPoid = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALDealPoid");
            // HiddenField hdnProductPoid = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALProductPoid");
            HiddenField hdnCustPrice = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALCustPrice");
            HiddenField hdnCustMRP = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALCustMRP");
            HiddenField hdnLcoPrice = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALLcoPrice");
            HiddenField hdnActivation = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALActivation");
            HiddenField hdnExpiry = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALExpiry");
            HiddenField hdnPackageId = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALPackageId");
            HiddenField hdnPurchasePoid = (HiddenField)grdCarte.Rows[rindex].FindControl("hdnALPurchasePoid");

            //check box for Ala Autorenewal
            CheckBox cbAlaAutorenew = (CheckBox)grdCarte.Rows[rindex].FindControl("cbAlaAutorenew");
            Hashtable htData = new Hashtable();
            // htData["planid"] = hdnPlanId.Value;
            htData["planname"] = hdnPlanName.Value;
            // htData["plantype"] = hdnPlanType.Value;
        ...
        protected void btnAddPlan_Click(object sender, EventArgs e)
        {
            ...
            TblPlanAddfinal.Columns.Add("cust_price1", typeof(double));
            ...
            foreach (GridViewRow gr in grdPlanChan.Rows)
            {
                HiddenField hdnplanaddPlanPoid = (HiddenField)gr.Cells[3].FindControl("hdnplanaddPlanPoid");
                HiddenField hdnplanaddDealPoid = (HiddenField)gr.Cells[3].FindControl("hdnplanaddDealPoid");
                HiddenField hdnplanaddproducteId = (HiddenField)gr.Cells[3].FindControl("hdnplanaddproducteId");
                HiddenField hdnplanaddplantype = (HiddenField)gr.Cells[3].FindControl("hdnplanaddplantype");
                CheckBox ChkPlanAddRenew = (CheckBox)gr.Cells[4].FindControl("ChkPlanAddRenew");
                CheckBox ChkPlanAdd = (CheckBox)gr.Cells[3].FindControl("ChkPlanAdd");

                if (ChkPlanAdd.Checked)
                {
                    String Plan_name = HttpUtility.HtmlDecode(gr.Cells[0].Text.Trim());
                    Double lcoprice = Convert.ToDouble(gr.Cells[3].Text.Trim());
                    Double custMRP = Convert.ToDouble(gr.Cells[2].Text.Trim());// + Convert.ToDouble(gr.Cells[1].Text.Trim()) * GSTValue;
                    ...
                    {
                        //result_arr[1];
                        TblPlanAddfinal.Rows.Add(Plan_name, custprice, Math.Round(custMRP), lcoprice, 0, 0, hdnplanaddPlanPoid.Value.Trim(), hdnplanaddDealPoid.Value.Trim(),
                    ...
                    else
                    {
                        if (hdnplanaddplantype.Value.Trim() == "B")
                        {
                            Double custMRP1 = custprice - Convert.ToDouble(result_arr[1]);
                            custMRP = custMRP1 + custMRP1 * GSTValue;
                        }
                        TblPlanAddfinal.Rows.Add(Plan_name, custprice, Math.Round(custMRP), lcoprice, Convert.ToDouble(result_arr[1]), custprice - Convert.ToDouble(result_arr[1]), hdnplanaddPlanPoid.Value.Trim(), hdnplanaddDealPoid.Value.Trim(),
                         hdnplanaddproducteId.Value.Trim(), hdnplanaddplantype.Value.Trim(), htData["autorenew"].ToString(), result_arr[1].ToString(), result_arr[0].ToString());
                    }
                }
            }
            ...
            else
            {
                ...
                if (TblPlanAddfinal.Rows.Count > 0)
                {
                    ...
                    GrdaddplanConfrim.Columns[2].FooterText = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("CUST_PRICE1")).Sum().ToString();
                    GrdaddplanConfrim.Columns[3].FooterText = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("LCO_PRICE")).Sum().ToString();
                    GrdaddplanConfrim.Columns[4].FooterText = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("discount")).Sum().ToString();
                    GrdaddplanConfrim.Columns[5].FooterText = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("netmrp")).Sum().ToString();
        ...
        protected void btnsearchplan_Click(object sender, EventArgs e)
        {
            ...
            if (radPlanAD.Checked)
            {
                str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1,  a.lco_price, a.payterm, " +
                    " a.cityid, a.company_code, a.insby, a.insdt  FROM view_lcopre_plan_fetch a " +
            ...
            {
                str = " (SELECT a.plan_id, a.plan_name, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price " +
                       " FROM view_lcopre_plan_fetchnew a " +
                      " where a.plan_type='AL' and a.cityid ='" + city + "' and upper(a.plan_name) like upper('" + search_text + "%')  " +
                       ...
                       " ) minus  " +
                       " ( " +
                       " SELECT c.num_plan_id,c.var_plan_name,c.num_plan_custprice,round(c.num_plan_custprice+(c.num_plan_custprice*" + GSTValue + ")) cust_Price1,c.var_plan_planpoid,c.var_plan_plantype,c.var_plan_dealpoid,c.num_plan_lcoprice " +
                       " FROM aoup_lcopre_plan_def a,aoup_lcopre_plan_channel b ,aoup_lcopre_plan_def c " +
                       "  where a.var_plan_name=b.var_plan_name " +
                       " and c.var_plan_proviid=b.var_plan_provi " +
                       "  AND b.var_plan_city=a.num_plan_cityid " +
            ...
            while (dr.Read())
            {
                ...
                ViewState["SearchedCustPrice1"] = dr["cust_pric1"].ToString();
        ...
        public bool GetLCOSharesPrice()
        {
            ...
            while (dr.Read())
            {
                ...
                ViewState["SearchedDealPoid"] = dr["deal_poid"].ToString();
                ViewState["SearchedCustPrice"] = dr["cust_price"].ToString();
                ViewState["SearchedCustPrice1"] = dr["cust_price1"].ToString();
                ViewState["SearchedLcoPrice"] = dr["lco_price"].ToString();
                // ViewState["SearchedActivation"] = dr["var_plan_planpoid"].ToString();
                // ViewState["SearchedExpiry"] = dr["var_plan_planpoid"].ToString();
                //=======================
        ...
        public void fillFreeALPlanGrid(String Basicpoid)
        {
            ...
            try
            {
                str = " SELECT a.plan_id, a.plan_name, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price,a.product_poid,'N' ALACARTEBASE,base_price  " +
                           " FROM view_lcopre_plan_fetchnew_free a " +
                          " where a.plan_type='AL' and a.cityid ='" + city + "' and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                           " and a.plan_poid not in (" + ala_poids + ") " +
                           " and a.payterm ='1' and a.plan_name like '%FREE%'" +
        ...
        protected void resetAddPopup()
        {
            ...
            if (Convert.ToString(ViewState["alacartebaseplan"]) == "Y")
            {
                ...
                if (grdBasicPlanDetails.Rows.Count > 0 && (Boolean)ViewState["BasepalnExpired"] == false)
                {
            ...
            if (ViewState["SearchedCustPrice1"] != null)
            {
                ViewState.Remove("SearchedCustPrice1");
            }
        ...
        protected void btnPopupFinalConfYes_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (hdnPopupAction.Value.ToString() == "C")//Added by Vivek Singh on 14-Jul-2016 for cancellation of all the plan if basic plan get cancelled   
                {
                    ...
                    {
                        if (htPlanData["plantypevalue"].ToString() == "B" || (htPlanData["planname"].ToString().Contains("SPECIAL") == true && htPlanData["plantypevalue"].ToString() != "HSP"))
                        {
                            string _tvType = "";
                            DataTable sortedDT = (DataTable)ViewState["vcdetail"];
                            DataTable myResultSet = sortedDT.Select("TAB_FLAG='" + hdntag.Value + "'").CopyToDataTable();
            ...
            try
            {
                ...
                else
                {
                    if (obrm_status == "0")
                    {
                        ...
                        hdnBasicPoidAddResponse.Value = "Transaction successful by OBRM but failure at UPASS : " + finalres[1];
        ...
        protected void radhwayspecial_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                " union SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1,  a.lco_price, a.payterm, " +
                    " a.cityid, a.company_code, a.insby, a.insdt  FROM view_lcopre_plan_fetch a " +
                ...
                if (TblPlans.Rows.Count > 0)
                {
                    Label7.Visible = false;
                    btnAddPlan.Visible = true;
                    ViewState["AddPlanList"] = TblPlans;
        ...
        protected void radPlanAD_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1,  a.lco_price, a.payterm, " +
                    " a.cityid, a.company_code, a.insby, a.insdt  FROM view_lcopre_lcoplan_fetch a " +
                    " where a.cityid ='" + city + "' and a.PLAN_TYPE_new='" + PlanTypenew + "' " +   //a.plan_type in ('RAD','GAD')  need to remove
                    //" and upper(a.plan_name) like upper('" + prefixText + "%') " +
                    " and a.plan_poid not in (" + addon_poids + ") and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                    " and var_plan_freeflag <> 'Y' " +
                    " and lcocode=" + Session["lcoid"].ToString() +
                    hd_where_clause +
                     " and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'" +
                " union SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1,  a.lco_price, a.payterm, " +
                        " a.cityid, a.company_code, a.insby, a.insdt  FROM view_lcopre_plan_fetch a " +
        ...
        protected void radPlanAL_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                str = " SELECT a.plan_id, a.plan_name, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price,a.product_poid " +
                           " FROM view_lcopre_lcoplan_fetchnew a " +
                          " where a.plan_type='AL' and a.cityid ='" + city + "' " +
                          " and a.plan_poid not in (" + ala_poids + ") " +
                           " and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'  and a.dasarea='" + Session["dasarea"].ToString() + "' and lcocode=" + Session["lcoid"].ToString() +
                        " union select * from ( (SELECT a.plan_id, a.plan_name, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price,a.product_poid " +
                           " FROM view_lcopre_plan_fetchnew a " +
                          " where a.plan_type='AL' and a.cityid ='" + city + "' " +
                          " and a.plan_poid not in (" + ala_poids + ") " +
                           " and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'  and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                           ...
                           " ) minus  " +
                           " ( " +
                           " SELECT c.num_plan_id,c.var_plan_name,c.num_plan_custprice,round(c.num_plan_custprice+(c.num_plan_custprice*" + GSTValue + ")) cust_Price1,c.var_plan_planpoid,c.var_plan_plantype,c.var_plan_dealpoid,c.num_plan_lcoprice,a.var_plan_productpoid product_poid " +
                           " FROM aoup_lcopre_plan_def a,aoup_lcopre_plan_channel b ,aoup_lcopre_plan_def c " +
                           "  where a.var_plan_name=b.var_plan_name " +
                           " and c.var_plan_proviid=b.var_plan_provi " +
                           "  AND b.var_plan_city=a.num_plan_cityid " +
        ...
        public void ddlChangeplanLco(string planType, string PayTerm)
        {
            ...
            try
            {
                ...
                string proviId = "";
                string strproviId = " select var_plan_proviid  from aoup_lcopre_plan_def ";
                ...
                if (planType == "B")
                {
                  ...
                  " and a.payterm =" + PayTerm + "" +
                   ...
                   " order by a.plan_name asc";
                    ...
                    // str = " SEzLECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                    //" a.cityid, a.company_code, a.insby, a.insdt  FROM view_lcopre_plan_fetch a " +
                    //" where a.cityid ='" + city + "' and a.plan_type='B'" +                        
                    //" and a.plan_poid not in (" + basic_poids + ")" +
                    //" and a.payterm =" + PayTerm + "" +
                ...
                else if (planType == "AL")
                {
                    ...
                    str = " select * from ( (SELECT a.plan_id, a.plan_name, a.cust_price,round(a.cust_price+(a.cust_price*" + GSTValue + ")) cust_Price1, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price " +
                            " FROM view_lcopre_lcoplan_fetchnew a " +
                            " where a.plan_type='AL' and a.cityid ='" + city + "' and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                        //and upper(a.plan_name) like upper('" + prefixText + "%')  " +
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        if (dr["plan_type"].ToString() == "B")
                        {
                            ...
                            Double ValueGST = custprice + custprice * GSTValue;
                            if (custprice < 0)
                            {
                                custprice = 0;
                            }

                            Tblchangeplan.Rows.Add(dr["plan_name"].ToString(), Convert.ToDouble(dr["cust_price"]), Math.Round(ValueGST), Convert.ToDouble(dr["lco_price"]), DiscountAmount,
                               custprice, dr["plan_poid"].ToString(), dr["deal_poid"].ToString(), dr["plan_type"].ToString());
                        }

                        else
                        {
                            Tblchangeplan.Rows.Add(dr["plan_name"].ToString(), Convert.ToDouble(dr["cust_price"]), Convert.ToDouble(dr["cust_price1"]), Convert.ToDouble(dr["lco_price"]), 0,
        ...
        public void ddlChangeplan(string planType, string PayTerm)
        {
            ...
            try
            {
                ...
                Tblchangeplan.Columns.Add("cust_price1", typeof(double));
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        if (dr["plan_type"].ToString() == "B")
                        {
                            ...
                            Double custprice = Convert.ToDouble(dr["cust_price"]) - DiscountAmount;
                            Double ValusGST = custprice + custprice * GSTValue;
                            if (custprice < 0)
                            {
                                custprice = 0;
                            }

                            Tblchangeplan.Rows.Add(dr["plan_name"].ToString(), Convert.ToDouble(dr["cust_price"]), Math.Round(ValusGST), Convert.ToDouble(dr["lco_price"]), DiscountAmount,
            ...
            while (dr.Read())
            {
                ...
                if (dr["plan_type"].ToString() == "B")
                {
                    ...
                    if (ViewState["discounttype"].ToString() == "P")
                    {
                        ...
                        DiscountAmount = Customerprice / 100 * DiscountAmount;
                        Double CustDisValue = Convert.ToDouble(dr["cust_price"].ToString()) - DiscountAmount;
                        Double ValueGST = CustDisValue + CustDisValue * GSTValue;
                    }
                }
        ...
        protected void btnChangePlan_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gr in GrdchangePlan.Rows)
            {
                ...
                if (rbtnchangeplanselect.Checked == true)
                {
                    ...
                    Hidchangplanlco.Value = gr.Cells[3].Text.Trim();
                ...
                if (status == true)
                {
                    ...
                    if (ViewState["OldPlanName"].ToString().Contains("BASIC SERVICE TIER") == true || ViewState["OldPlanName"].ToString().Contains("PRIME") == true)
                    {
                        ...
                        for (int rowindexi = 1; rowindexi <= grdAddOnPlan.Rows.Count; rowindexi++)
                        {
                            ...
                            HiddenField hdnCustMRP = (HiddenField)grdAddOnPlan.Rows[rowindex].FindControl("hdnADCustMRP");
                    ...
                    if (ViewState["alacartebaseplan"].ToString() == "Y" && ViewState["alacartechangebase"].ToString() == "B")
                    {
                        ...
                        foreach (GridViewRow gr in grdCartefree.Rows)
                        {
                            ...
                            HiddenField hdnCustMRP = (HiddenField)gr.FindControl("hdnALCustMRP");
                            ...
                            if (hdnPlanName.Value.Trim().Contains("FREE"))
                            {
                                ...
                                processTransaction_cancellation(_vc_id,Stb_no, _tvType, maintStatus, ViewState["ServicePoid"].ToString());
                    ...
                    if (ViewState["alacartechangenew"].ToString() == "Y" && ViewState["alacartechangebase"].ToString() == "B")
                    {
                        ...
                        foreach (GridViewRow gr in grdAddOnPlan.Rows)
                        {
                            ...
                            HiddenField hdnCustPrice = (HiddenField)gr.FindControl("hdnADCustPrice");
                            HiddenField hdnCustMRP = (HiddenField)gr.FindControl("hdnADCustMRP");
        ...
        protected void setChangePopup(string message1, string message2, string flag, string grid, Hashtable ht)
        {
            try
            {
                lbldayremainch.Text = ht["dayremain"].ToString();
                lblPopupText1.Text = message1;
                lblPopupText2.Text = message2;
        ...
        protected void lnkBRenew_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hdnBasicCustMRP = (HiddenField)grdBasicPlanDetails.Rows[rindex].FindControl("hdnBasicCustMRP");
            ...
            htData["custMRP"] = hdnBasicCustMRP.Value;
        ...
        protected void btnAddFreePlan_Click(object sender, EventArgs e) // Added by vivek 04-Jan-2016
        {
            ...
            for (int i = 0; i <= grdFreePlan.Rows.Count - 1; i++)
            {
                ...
                if (chk.Checked == true)
                {
                    ...
                    if (TblPlanAddfinal != null)
                    {
                        TblPlanAddfinal.Rows.Add(grdFreePlan.Rows[i].Cells[0].Text.ToString(), 0, 0, 0, 0, 0, ((HiddenField)(grdFreePlan.Rows[i].FindControl("hdnFreePlanPoid"))).Value.ToString(), "", "", "AD", "NL", "9999", "");
                    }
                }
            }
        ...
        public void SendFOC_CancelRequest(String FOCPlanId) // Added By Vivek 15-Feb-2016
        {
            ...
            for (i = 0; i < grdAddOnPlanReg.Rows.Count; i++)
            {
                ...
                if (value == FOCPlanId)
                {
                    ...
                    HiddenField hdnCustMRP = (HiddenField)grdAddOnPlanReg.Rows[i].FindControl("hdnADCustMRP");
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            responsemodify_params += "$" + ViewState["ModifyArea"].ToString() + "$" + ViewState["ModifyState"].ToString() + "$" + MiddleName + "$" + ViewState["ModifyAddress1"].ToString();
            try
            {
                    ...
                    else if (service_data_arr[0] == "9999" && service_data_arr[1].Replace("~", "") != "")
                    {
                        ...
                        foreach (string plan_data in data_arr)
                        {
                            ...
                            if (plan_details_arr[9].ToString() == "Active")
                            {
                                ...
                                htData["custMRP"] = Convert.ToString(Convert.ToDouble(plan_details_arr[2].ToString()) * GSTValue);
                                ...
                                else
                                {
                                    ...
                                    processTransaction_cancellation(vc,stb_no, Tv_Type, stb_status, service_poid);
        ...
        protected void processTransaction_cancellation(string Vcid,string stb_no, string Tv_Type, string Status, string Servicepoid)  //Added by Vivek Singh on 12-Jul-2016
        {
            try
            {
                ViewState["ErrorMessage"] = null;
            ...
            while (dr1.Read())
            {
                ...
                if (dtBasicPlans.Rows.Count > 0)
                {
                    if (ViewState["discounttype"].ToString() != "P")
                    {
                        ...
                        Double cust_disc = Convert.ToDouble(dtBasicPlans.Rows[0]["cust_price"]) - Convert.ToDouble(ViewState["DiscountAmount"]);
                        dtBasicPlans.Rows[0]["cust_price1"] = Math.Round(cust_disc + cust_disc * GSTValue);
                    }
                    else
                    {
                        dtBasicPlans.Rows[0]["DISCOUNT"] = Convert.ToDouble(ViewState["DiscountAmount"].ToString()).ToString() + " %";
                        Double cust_disc = Convert.ToDouble(dtBasicPlans.Rows[0]["cust_price"]) * Convert.ToDouble(ViewState["DiscountAmount"]) / 100;
                        Double Plan_DiscPrice = Convert.ToDouble(dtBasicPlans.Rows[0]["cust_price"]) - cust_disc;
                        dtBasicPlans.Rows[0]["cust_price1"] = Math.Round(Plan_DiscPrice + Plan_DiscPrice * GSTValue);
                    }
        ...
        protected void btnSwap_click(object sender, EventArgs e)
        {
            ...
            ddlSwapChildTV.Items.Insert(0, "Select VC");
        ...
        protected void btnFaultyConf_Click(object sender, EventArgs e)
        {
            ...
            if (Getresponse[0] == "9999")
            {
                ...
                lblFaultyCofReason.Text = ViewState["FaultyReason"].ToString();
                mpeFaulty.Show();
        ...
        {
            DataTable dt = new DataTable();
            dt = (DataTable)ViewState["AddPlanList"];
            DataView DTView = dt.DefaultView;
            if (txtName.Text != "")
            {
                DTView.RowFilter = "PLAN_NAME like '%" + txtName.Text + "%'";
            }
            grdPlanChan.DataSource = DTView;
            grdPlanChan.DataBind();
            txtName.Attributes["onfocus"] = "var value = this.value; this.value = ''; this.value = value; onfocus = null;";
            txtName.Focus();
            //txtName.Focus();
