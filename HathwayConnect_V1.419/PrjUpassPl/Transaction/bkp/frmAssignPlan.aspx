...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function CheckOtherIsCheckedByGVID(spanChk) {
            ...
            var Chk = spanChk;
            Parent = document.getElementById("<%=GrdchangePlan.ClientID%>");
...
//                    table = table.rows[r].cells[1].innerHTML;
                //                }
  ...
  <script language="javascript">
      ...
      function SelectAllCheckboxes(chk) {
          debugger;
          var gv = document.getElementById("<%=grdPlanChan.ClientID%>");
            var inputs = gv.getElementsByTagName("input");
            for (var i = 0; i < inputs.length; i++) {
                if (inputs[i].type == "CheckBox") {
                    var row = inputs[i].parentNode.parentNode;
                    var txtItemQuantity = GetChildControl(row, "hdnplanaddPlanPoid");
                    var txtThirdCell = GetChildControl(row, "hdnplanaddDealPoid");
                    if (inputs[i].checked) {
            ...
            if (id.checked == true) {
                ...
                for (k = 0; k < 6; k++) {
                    if (k == 0) {
                        ...
                        if (gv != null) {
                            if (gv.rows.length > 0) {
                                var chk = gv.rows[0].cells[8];
                                for (i = 0; i < gv.rows.length; i++) {
                                    cell = gv.rows[i].cells[8];
        ...
        <ContentTemplate>
            <div class="maindive">
                <div class="griddiv">
                                            ...
                                            <table style="border-collapse: collapse" width="100%">
                                                            ...
                                                            <asp:GridView ID="grdBasicPlanDetails" CssClass="Grid" runat="server" AutoGenerateColumns="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField HeaderText="Base Price" DataField="CUST_PRICE" ItemStyle-HorizontalAlign="Left"
                                                                        ItemStyle-Width="80" />
                                                                        <asp:BoundField HeaderText="MRP" DataField="cust_price1" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField HeaderText="LCO Price" DataField="LCO_PRICE" ItemStyle-HorizontalAlign="Left"
                                                                        ItemStyle-Width="80" />
                                                                    <asp:BoundField HeaderText="Discount" DataField="DISCOUNT" ItemStyle-HorizontalAlign="Left"
                                                                        ItemStyle-Width="80" />
                                                                    <asp:BoundField HeaderText="Activation" DataField="ACTIVATION" ItemStyle-Width="100"
                                                                        ItemStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField HeaderText="Valid Upto" DataField="EXPIRY" ItemStyle-Width="100"
                                                                        ItemStyle-HorizontalAlign="Left" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-anchor-bottom-right dropdown-has-anchor" id='<%# "basic"+Container.DataItemIndex+1 %>'>
                                                                                <ul>
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="lnkaddplanbaseexpired" runat="server" Text="ADD" OnClick="lnkaddplanbaseexpired_Click"
                                                                                            Width="110" /></a></li>
                                                                                    <li><a href="#">
                                                                                    ...
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="lnkBChange" runat="server" Text="CHANGE" OnClick="lnkBChange_Click"
                                                                                            Width="110" /></a></li>
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="lnkAddFOCPack" runat="server" Text="FOC PACK" OnClick="lnkAddFOC_Click"
                                                                                            Width="110" /></a></li>
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="btnALPack" runat="server" Text="A-La-Carte Pack" OnClick="btnALPack_Click"
                                                                                            Width="110" /></a></li>
                                                                                    <li><a href="#">
                                                                                        <asp:Button ID="btnDiscnt" runat="server" Text="DISCOUNT" OnClick="btnDiscnt_Click"
                                                                                            Width="110" /></a></li>
                                                                                </ul>
                                                                            </div>
                                                                            ...
                                                                            <asp:HiddenField ID="hdnBasicCustMRP" runat="server" Value='<%# Eval("CUST_PRICE1").ToString()%>' />
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center">
                                                        <b>
                                                            <asp:Label ID="lblhathwayspecial" runat="server" Text="Hathway Special"></asp:Label>
                                                        </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" align="left">
                                                        <cc1:Accordion ID="hathspecialAccordion" runat="server" SelectedIndex="-1" HeaderCssClass="accordionHeader"
                                                            HeaderSelectedCssClass="accordionHeaderSelected" ContentCssClass="accordionContent"
                                                            FadeTransitions="true" SuppressHeaderPostbacks="true" TransitionDuration="250"
                                                            FramesPerSecond="40" RequireOpenedPane="false" AutoSize="None">
                                                            <Panes>
                                                                <cc1:AccordionPane ID="HathSpecialAccordionPane" runat="server">
                                                                    <Header>
                                                                        <a href="#" class="href" style="color: White;">Hathway Special</a></Header>
                                                                    <Content>
                                                                        <div class="plan_scroller">
                                                                            <asp:GridView ID="Grdhathwayspecial" CssClass="Grid" Width="100%" runat="server"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundField HeaderText="Base Price" DataField="CUST_PRICE" ItemStyle-HorizontalAlign="left"
                                                                                        ItemStyle-Width="70" />
                                                                                        <asp:BoundField HeaderText="MRP" DataField="cust_price1" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="LCO Price" DataField="LCO_PRICE" ItemStyle-HorizontalAlign="Left"
                                                                                        ItemStyle-Width="80" />
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                                                                                        <ItemTemplate>
                                                                                           ...
                                                                                           <asp:HiddenField ID="hdnADPlanType" runat="server" Value='<%# Eval("PLAN_TYPE").ToString()%>' /> 
                                                                                            ...
                                                                                            <asp:HiddenField ID="hdnADCustMRP" runat="server" Value='<%# Eval("CUST_PRICE1").ToString()%>' />
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center">
                                                        <b>
                                                            <asp:Label ID="lblAddonPlan" runat="server" Text="Genre Addon Plans"></asp:Label>
                                                        </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center">
                                                        <b>
                                                            <asp:Label ID="lblAddonPlanReg" runat="server" Text="Regional Addon Plans"></asp:Label>
                                                        </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" align="left">
                                                        <cc1:Accordion ID="AddonAccordionReg" runat="server" SelectedIndex="-1" HeaderCssClass="accordionHeader"
                                                            ...
                                                            FramesPerSecond="40" RequireOpenedPane="false" AutoSize="None">
                                                            <Panes>
                                                                <cc1:AccordionPane ID="AddonAccordionPaneReg" runat="server">
                                                                    <Header>
                                                                        <a href="#" class="href" style="color: White;">Addon Plans</a></Header>
                                                                    <Content>
                                                                        <div class="plan_scroller">
                                                ...
                                                <tr>
                                                    <td align="center" colspan="2">
                                                        <b>
                                                            <asp:Label ID="lblAlacartePlanFree" runat="server" Text="A-La-Carte FREE" ForeColor="White"></asp:Label>
                                                ...
                                                <tr>
                                                    <td colspan="2" align="left">
                                                        <cc1:Accordion ID="AlacarteAccordionFree" runat="server" SelectedIndex="-1" HeaderCssClass="accordionHeader"
                                                            ...
                                                            FramesPerSecond="40" RequireOpenedPane="false" AutoSize="None">
                                                            <Panes>
                                                                <cc1:AccordionPane ID="AlacartefreeAccordionPane" runat="server">
                                                                    <Header>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:HiddenField ID="hdnALCustPrice" runat="server" Value='<%# Eval("CUST_PRICE").ToString()%>' />
                                                                                             <asp:HiddenField ID="hdnALCustMRP" runat="server" Value='<%# Eval("CUST_PRICE1").ToString()%>' />
                    ...
                    <asp:Panel ID="pnlConfirmation" runat="server" CssClass="Popup" Style="width: 430px;
                        display: none; height: 360px;">
                        <%-- display: none; --%>
                        ...
                        <center>
                            ...
                            <table width="85%">
                                ...
                                <tr id="RenewDiscount" runat="server">
                                    <td align="left">
                                        <b>
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="pnladdplan" runat="server">
                                        ...
                                        <table width="90%" runat="server" id="AddExpiredplan">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" runat="server" id="tdRadioHolder">
                                                    ...
                                                    <asp:RadioButton ID="radhwayspecial" runat="server" GroupName="RadPlanType" Text="Hathway Special"
                                                        AutoPostBack="true" OnCheckedChanged="radhwayspecial_CheckedChanged" />
                                                    <asp:RadioButton ID="radPlanAD" runat="server" GroupName="RadPlanType" Text="Genre Addon"
                                                        OnCheckedChanged="radPlanAD_CheckedChanged" AutoPostBack="true" />
                                                    <asp:RadioButton ID="radPlanADreg" runat="server" GroupName="RadPlanType" Text="Regional Addon"
                                                        OnCheckedChanged="radPlanAD_CheckedChanged" AutoPostBack="true" />
                                        ...
                                        <table width="100%">
                                           ...
                                           <asp:TextBox ID="txtName" runat="server" Width="100" MaxLength="50" OnKeyUp="javascript:return myFunction();"></asp:TextBox>  <%--OnKeyUp="javascript:return myFunction();"--%>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <asp:Panel ID="pnlnewlangrd" runat="server" Style="max-height: 300px; height: auto;
                                                        ...
                                                        <asp:GridView ID="grdPlanChan"  CssClass="Grid" runat="server" AutoGenerateColumns="false" >
                                                            <Columns>
                                                                <asp:BoundField HeaderText="Plan Name" DataField="PLAN_NAME" ItemStyle-HorizontalAlign="Left"
                                                                    ItemStyle-Width="625" />
                                                                <asp:BoundField HeaderText="Base Price" DataField="CUST_PRICE" ItemStyle-HorizontalAlign="Left"
                                                                ...
                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Select" ItemStyle-Width="50">
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="ChkPlanAdd" runat="server" onclick="javascript:SelectAllCheckboxes(this);"
                                                                             />
                                                                ...
                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="AutoRenew" ItemStyle-Width="50">
                                                                    <ItemTemplate>
                                            ...
                                            <asp:GridView ID="GrdaddplanConfrim" CssClass="Grid" runat="server" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Base Price" DataField="CUST_PRICE" ItemStyle-HorizontalAlign="Right"
                                                        ...
                                                        <asp:BoundField HeaderText="MRP" DataField="cust_price1" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
                                                    ...
                                                    <asp:BoundField HeaderText="Net MRP" DataField="netmrp" ItemStyle-HorizontalAlign="Right"
                                                        ItemStyle-Width="80" FooterStyle-HorizontalAlign="Right" />
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="AutoRenew" ItemStyle-Width="50">
                                                        <ItemTemplate>
                    ...
                    <cc1:ModalPopupExtender ID="popupRenewAll" runat="server" BehaviorID="mpeServiceS"
                        TargetControlID="btnRenSubmit" PopupControlID="pnlServiceS" CancelControlID="imgClose4">
                    </cc1:ModalPopupExtender>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="grdRenewNow" CssClass="Grid" runat="server" AutoGenerateColumns="false">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Base Price" DataField="CUST_PRICE" ItemStyle-HorizontalAlign="left"
                                                            ItemStyle-Width="70" />
                                                            <asp:BoundField HeaderText="MRP" DataField="CUST_PRICE1" ItemStyle-HorizontalAlign="left"
                                                            ItemStyle-Width="70" />
                                                        <asp:BoundField HeaderText="Status" DataField="PLAN_STATUS" ItemStyle-HorizontalAlign="Left"
                                                            ItemStyle-Width="60" />
                                                        <asp:TemplateField HeaderText="Renew Now" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hdnCustMRP" runat="server" Value='<%# Eval("CUST_PRICE1").ToString()%>' />
                            ...
                            <table width="90%">
                                ...
                                <tr>
                                    <td align="center" colspan="3">
                                        ...
                                        &nbsp;&nbsp;
                                        <input id="Button4" class="button" type="button" value="No" style="width: 100px;"
                        ...
                        <table width="90%">
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    ...
                                    &nbsp;&nbsp;
                                    <input id="Button8" class="button" type="button" value="No" style="width: 100px;"
            ...
            <asp:GridView ID="GrdchangePlan" CssClass="Grid" runat="server" AutoGenerateColumns="false" ShowFooter="false">
                                                                <Columns>
                                                                    <asp:BoundField HeaderText="Plan Name" DataField="PLAN_NAME" ItemStyle-HorizontalAlign="Left"  FooterStyle-HorizontalAlign="Right"
                                                                     ...
                                                                     <asp:BoundField HeaderText="Base Price" DataField="CUST_PRICE" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"
                                                                        ItemStyle-Width="80" />
                                                                        <asp:BoundField HeaderText="MRP" DataField="CUST_PRICE1" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"
                                                                        ItemStyle-Width="80" />
                                                                    ...
                                                                    <asp:BoundField HeaderText="Net MRP" DataField="netmrp" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="80" FooterStyle-HorizontalAlign="Right"/>
                                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Select" ItemStyle-Width="50">
                                                                        <ItemTemplate>
                                                                            <asp:RadioButton ID="rbtnchangeplanselect" runat="server" onclick = "CheckOtherIsCheckedByGVID(this);"  /> <%--onclick = "RadioCheck(this);"--%>
                                                                            <asp:HiddenField ID="hdnplanaddconfPlanPoid" runat="server" Value='<%# Eval("plan_poid").ToString()%>' />
                                                                            <asp:HiddenField ID="hdnplanaddconfDealPoid" runat="server" Value='<%# Eval("DEAL_POID").ToString()%>' />
                ...
                <asp:Panel ID="pnlChangeConfirmation" runat="server" CssClass="Popup" Style="width: 430px;
                    ...
                    <center>
                        ...
                        <table width="85%">
                            ...
                            <tr>
                                <td align="left">
                                    <b>
                                        <asp:Label ID="Label15" runat="server" Text="Day Remain"></asp:Label></b>
                                </td>
                                <td>
                                    <asp:Label ID="Label32" runat="server" Text=":"></asp:Label>
                                </td>
                                <td align="left">
                                    <asp:Label ID="lbldayremainch" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                            ...
                            <td align="left">
                                <b>
                                    <asp:Label ID="Label120" runat="server" Text="LCO Pay Amount"></asp:Label></b>
                            </td>
                            <td>
                ...
                <asp:Panel ID="pnlMessage" runat="server" CssClass="Popup" Style="width: 430px; height: 160px;
                    ...
                    <asp:Image ID="imgClose2" ToolTip="Close" runat="server" Style="z-index: -1; float: right;
                        margin-top: -15px; margin-right: -15px;" onclick="closeMsgPopup();" ImageUrl="~/Images/closebtn.png" Visible="false" />
                    <center>
                        <br />
                        <table width="100%">
                            <tr>
                        ...
                        <table width="90%">
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    <input id="btnClodeMsg" runat="server" class="button" type="button" value="Close"
                                        style="width: 100px;" onclick="closeMsgPopup();" visible="false" />
                                    <asp:Button ID="btnRefreshForm" runat="server" CssClass="button" Text="OK" Visible="true"
                ...
                <asp:Panel ID="pnlFOCMessgae" runat="server" CssClass="Popup" Style="width: 430px;
                    ...
                    <center>
                        ...
                        <table width="90%">
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    <input id="btnFOCMsgClose" class="button" type="button" value="Close"
                        ...
                        <table width="90%">
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    ...
                                    &nbsp;&nbsp;
                                    <input id="Button1" class="button" type="button" value="No" style="width: 100px;"
                        ...
                        <table width="90%">
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    ...
                                    <input id="Button7" class="button" type="button" value="Close" style="width: 100px;"
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="grdALfree" EmptyDataText="No Plan Found" CssClass="Grid" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="MRP" DataField="cust_price1" ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Left" />
                        ...
                        <table width="90%">
                            <tr>
                                ...
                                <td align="left" colspan="2">
                                    <asp:TextBox runat="server" Width="150px" ID="txtModifyFirstName" MaxLength="100" Enabled="false"
                                    ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" colspan="2">
                                    <asp:TextBox runat="server" Width="150px" ID="txtModifyMiddleName"  Enabled="false" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                ...
                                <td align="left" colspan="2">
                                    <asp:TextBox runat="server" Width="150px" ID="txtModifylastName"  Enabled="false" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="2" rowspan="2">
                                    <asp:TextBox runat="server" Width="150px" ID="txtmodifyAddress"  Enabled="false" TextMode="MultiLine"
                            ...
                            <tr>
                                <td align="center" colspan="5">
                                    ...
                                    &nbsp;&nbsp;
                                    <input id="btnModifycustCan" class="button" type="button" value="Cancel"
                        ...
                        <table width="90%">
                            ...
                            <tr>
                                <td align="center" colspan="5">
                                    ...
                                    &nbsp;&nbsp;
                                    <input id="Button6" class="button" type="button" value="Cancel" style="width: 100px;"
                        ...
                        <table width="90%">
                            <tr>
                                <td align="center" colspan="3">
                                    ...
                                    <input id="btnAutopopClose" class="button" type="button" value="Cancel"
                            ...
                            <td align="center">
                                <div class="delInfo" id="div3" runat="server">
                                    <table runat="server" align="center" width="75%" id="Table3" border="0">
                                        <tr>
                                            <td align="right">
                                                <input id="Button2" class="button" type="button" value="Cancel" style="width: 100px;"
                ...
                <asp:Panel ID="pnlSwapAl" runat="server" CssClass="Popup" Style="width: 650px;
                    ...
                    <center>
                        ...
                        <table width="90%">
                            ...
                            <tr>
                            <td align="right">
                            <asp:Label ID="Label1048" runat="server" Text="Child VC :"></asp:Label>
                                ...
                                <td align="right">
                                <asp:Label ID="Label1047" runat="server" Text="Child STB :"></asp:Label>
                    ...
                    <table>
                        <tr>
                            <td style=" width: 80px;" align="right">
                                <asp:Label ID="Label47" runat="server" Text="Child VC :"></asp:Label>
                            </td>
                            <td align="left">
                            ...
                            <td style=" width: 80px;"  align="right">
                                <asp:Label ID="Label49" runat="server" Text="Main VC :"></asp:Label>
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            <td style=" width: 80px;" align="right">
                                <asp:Label ID="Label52" runat="server" Text="Child STB :"></asp:Label>
                            </td>
                            <td align="left">
                            ...
                            <td style=" width: 80px;" align="right">
                                <asp:Label ID="Label54" runat="server" Text="Main STB :"></asp:Label>
                            </td>
                            <td align="left">
                    ...
                    <center>
                        ...
                        <table width="90%">
                            <tr>
                                ...
                                <asp:TextBox ID="txtfaultyNewSTBID" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            <td>
