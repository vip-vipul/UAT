<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="HwayTransInventryOnlinePayment.aspx.cs" Inherits="PrjUpassPl.Transaction.HwayTransInventryOnlinePayment" %>
                                ...
                                <tr id="Tr1" runat="server">
                                 ...
                                 <tr id="Tr2" runat="server">
                                        ...
                                        <td align="left"  width="65px">
                                            <asp:RadioButton ID="rdcitrus" Text="Citrus" runat="server" GroupName="A" Checked="false"/>
                                        </td>
                                        <td align="left">
                                            <asp:Image ID="Image2" runat="server" Width="60px" ImageUrl="~/Images/Citrus_Payment_Gateway.png"
                                                Height="35px" />
                                        </td>
                                    </tr>
                            </table>
