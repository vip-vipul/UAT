<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransHwayUserCreditLimit.aspx.cs"
    Inherits="PrjUpassPl.Transaction.TransHwayUserCreditLimit" MasterPageFile="~/MasterPage.Master" %>
                            ...
                            <td align="center">
                                <div class="delInfo">
                                    <table runat="server" align="center" width="100%" id="tbl1" border="0">
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblUser" runat="server" Text="Search User By"></asp:Label><asp:Label runat="server" Text="*" ForeColor="red"></asp:Label>
                                            </td>
                                            <td>
                                    ...
                                    <div class="delInfo">
                                        <table class="delInfoContent">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:Label runat="server" ID="lblmobno" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:Label runat="server" ID="lblCurLimit" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                        ...
                                        <table width="96%" cellpadding="2">
                                            <tr>
                                                <td colspan="6" align="left">
                                                    <b>
                                                        <asp:Label runat="server" ID="Label14" Text="Assigning Balance:"></asp:Label>
                                                    </b>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="100px" align="left" class="style68">
                                                    <asp:Label ID="Label9" runat="server" Text="Assign Balance"></asp:Label><asp:Label ID="Label1" runat="server" Text="*" ForeColor="red"></asp:Label>
                                                </td>
                                                <td class="style68">
