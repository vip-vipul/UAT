<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="TransHwayLcoCashPaymentRev.aspx.cs" Inherits="PrjUpassPl.Transaction.TransHwayLcoPaymentRev_Replica" %>
                                ...
                                <tr>
                                    <td align="center">
                                        <div class="delInfo">
                                            <table runat="server" align="center" width="100%" id="tbl1" border="0">
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="Label22" runat="server" Text="Receipt No."></asp:Label>
                                                        &nbsp;
                                        ...
                                        <div id="divdet" runat="server">
                                            <div class="delInfo">
                                                <cc1:Accordion ID="LCO_PaymentAddonAccordion" runat="server" SelectedIndex="-1" HeaderCssClass="accordionHeader"
                                                    HeaderSelectedCssClass="accordionHeaderSelected" ContentCssClass="accordionContent"
                                                    FadeTransitions="true" SuppressHeaderPostbacks="true" TransitionDuration="250"
                                                    FramesPerSecond="40" RequireOpenedPane="false" AutoSize="None">
                                                    <Panes>
                                                        <cc1:AccordionPane ID="LCO_PaymentAccordionPane" runat="server">
                                                            <Header>
                                                                            ...
                                                                            <table class="delInfoContent" style="padding-right: 50px; margin-top: 1px;">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" colspan="2">
                                                                                        <asp:Label runat="server" ID="lblLcoAddr" Width="200px"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="style69">
                                                            ...
                                                            <td align="left">
                                                                <asp:Label runat="server" ID="lblLcoBank" Text="" Width="200px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="style68">
                                            ...
                                            <div class="delInfo">
                                                <table width="96%" cellpadding="2">
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:DropDownList ID="ddlReason" runat="server" Style="resize: none;" Width="304px"
                                                                Height="19px">
