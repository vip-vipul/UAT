<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="TransHwayBulkActivation.aspx.cs" Inherits="PrjUpassPl.Transaction.TransHwayBulkActivation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterBody" runat="server">
    ...
    <div class="maindive">
        ...
        <div class="delInfo" style="margin-top: 11px;">
            ...
            <a href="../GeneratedFiles/DemoExcel/BulkActivation.xlsx" id="bulktransaction" runat="server">
                Download Template</a> <a href="../GeneratedFiles/DemoExcel/BulkChangeActivation.xlsx" id="bulkchange"
        ...
        <div>
            ...
            <br />
            <asp:LinkButton ID="lnkfileStatus" runat="server" Text="View The Uploaded file Status" Visible="false"
        ...
        <!--sanket-->
        <div class="delInfo" id="Operation" runat="server" visible="false" style="margin-top: 10px;
            text-align: left; height: 280px">
            <center>
                <h2>
                    Steps to use the bulk upload file for bulk allocation</h2>
            </center>
            <div style="margin-left: 2%">
                <ol>
                    ...
                    <li style="float: left">Scheduler Date should be dd/mm/yyyy format. </li>
                     <li style="float: left">Renewal Flag can be Y (Yes) or N (No). Blank input will be considered as N by default. </li>
                    <br />
                    <li style="float: left">Save the Excel file as Text Tab Delimited file on your PC.Except
                        for input fields from column A to column G, please remove all other data including
        ...
        <div class="delInfo" id="change" runat="server" visible="false" style="margin-top: 10px;
            text-align: left; height: 280px">
            <center>
                <h2>
            ...
            <div style="margin-left: 2%">
                <ol>
                    ...
                    <li style="float: left">Save the Excel file as Text Tab Delimited file on your PC.
