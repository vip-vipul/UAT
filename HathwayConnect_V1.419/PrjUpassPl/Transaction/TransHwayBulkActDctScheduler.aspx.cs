...
{
    public partial class TransHwayBulkActDctScheduler : System.Web.UI.Page
    {
        string username;
        string upload_id;
        protected void Page_Load(object sender, EventArgs e)
        {
            Master.PageHeading = "Bulk ACT and DEACT Scheduler";
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            string table_columns = "( VAR_ACTDCT_ACCNO, VAR_ACTDCT_VCID, VAR_ACTDCT_REASON, VAR_ACTDCT_LCOCODE,var_actdct_action,VAR_ACTDCT_FILENAME constant \"" + file_name + "\",DAT_ACTDCT_DT,VAR_ACTDCT_FILEUNIQUEID constant \"" + upload_id + "\",DAT_ACTDCT_ACTIVITYFLAG)";

            string uploadResult = helper.cDataUpload("D:\\DataUpload\\HathwayBulk\\" + username + "\\" + fupData.PostedFile.FileName,
                                                     "D:\\DataUpload\\HathwayBulk\\" + username + "\\HathwayBulkActDctSHECDCTL.txt",
                                                     "D:\\DataUpload\\HathwayBulk\\" + username + "\\HathwayBulkActDctSHECDLOG.log",
                                                     table_columns, "Upassdb", "UPASS", "cba", "AOUP_LCOPRE_BULK_ACT_SHEC_RAW", ""
                                                     );
        ...
        private void callprocedureTemp()
        {
            ...
            string pro_output = obj.bulkSchedulUploadTemp(username, IPAdd, ViewState["upload_id"].ToString());  //"9999#RP"; //
