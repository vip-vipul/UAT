...
{
    public partial class FrmOnlinepaymentMobRcpt : System.Web.UI.Page
    {
        ...
        public void Pnltopdf()
        {
            Response.ContentType = "application/pdf";
            Response.AddHeader("content-disposition", "attachment;filename=Recipt_" + Session["rcpt_pt_rcptno2"].ToString() + ".pdf");
            Response.Cache.SetCacheability(HttpCacheability.NoCache);
            StringWriter sw = new StringWriter();
            HtmlTextWriter hw = new HtmlTextWriter(sw);
            pnlRcpt.RenderControl(hw);
