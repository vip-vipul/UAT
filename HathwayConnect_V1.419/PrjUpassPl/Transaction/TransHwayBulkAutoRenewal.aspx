...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterBody" runat="server">
    ...
    <div class="delInfo">
        ...
        <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" />
         &nbsp;<a href="../GeneratedFiles/DemoExcel/Bulk_Auto_Renewal_n.xlsx" id="bulktransaction" runat="server">Download Template</a>
    </div>
    <br />
    <div class="delInfo" id="Operation" runat="server" visible="true" style="margin-top: 10px; text-align: left; 
            ...
            <div style="margin-left: 2%">
                <ol>
                    ...
                    <li style="float: left">Auto Renew Upto Date ( column F) Date Format shold be DD-MON-yyyy.</li><br />
