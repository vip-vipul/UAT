...
{
    public partial class TransBalanceManagementPages : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Master.PageHeading = "Balance Management";
            if (!IsPostBack)
            {
                Session["pagenos"] = "0";
        ...
        private void BindData()
        {
            try
            {
                ...
                str += " and num_frm_cat in ('2','3') and a.num_frm_id=b.num_rights_frmid  ";
                str += " and num_frm_id in (7,41,49,52,58) ";
