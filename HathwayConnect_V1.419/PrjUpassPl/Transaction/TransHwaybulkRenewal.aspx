...
function back1()
    ...
    <div class="maindive">
     <div style="float:right">
             <asp:Label ID="lblLastRefreshTime" runat="server" Text="" style="margin-right: 50px; margin-top: -15px;"></asp:Label>    <button onclick="return back1()"  style="margin-right:5px;margin-top:-15px;"   class="button">Back</button>
                </div>
        <div class="tblSearchItm" style="width: 55%;">
            <table width="100%">
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtFrom" runat="server" AutoPostBack="true" BorderWidth="1" 
            ...
            <table width="100%">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="center">
                                            ...
                                            &nbsp;&nbsp;
                                            <asp:RadioButton runat="server" ID="rbHSP" GroupName="type" Text="Hathway Bouquet" OnCheckedChanged="rbHSP_CheckedChanged" />
                                            &nbsp;&nbsp;
                                            <asp:RadioButton runat="server" ID="rbAD" GroupName="type" Text="Broadcaster Bouquet" OnCheckedChanged="rbAD_CheckedChanged" />
                                            &nbsp;&nbsp;
                ...
                <tr >
                                       <td align="center" valign="middle">
                                        <asp:CheckBox ID="chkVCID" runat="server" /> VC ID :
                                         <asp:TextBox ID="txtvcid" runat="server" MaxLength="20"  ></asp:TextBox>
                    ...
                    <div id="Divgrd" class="griddiv">
                        ...
                        OnSorting="grdLcoPartyLedger_Sorting"--%>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2900" >
                                    <HeaderTemplate>
                                        <asp:Label ID="lblAllRenew" runat="server" Text="Select All " ></asp:Label>
                                        <br />
                                        <asp:Label ForeColor=Red ID="Label15" runat="server" Text="(ALl Plan Will Renew)" ></asp:Label>
                                        <br />
