...
{
    public partial class HwayTransInventryOnlinePayment : System.Web.UI.Page
    {
        string username = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Master.PageHeading = "Inventory Online Payment";
                Session["pagenos"] = "1";
        ...
        public void SetBalance()
        {
            ...
            obj.GetBalance(ddllco.SelectedValue, out Balance, out InBalance);
            lblCurrBalance.Text = InBalance;
        }
