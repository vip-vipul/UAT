...
{
    public partial class TransHwayBulkChangePlan : System.Web.UI.Page
    {
        string username;
        string upload_id;
        protected void Page_Load(object sender, EventArgs e)
        {
            Master.PageHeading = "Bulk Change plan Transaction";
            if (!IsPostBack)
            {
               // Session["username"] = "N";
        ...
        {
            Cls_Business_TransHwayBulkChangePlan obj = new Cls_Business_TransHwayBulkChangePlan();
        ...
        protected void lnkfileStatus_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Reports/rptbulkprocdetails.aspx?uniqueid=" + ViewState["upload_id"]);
