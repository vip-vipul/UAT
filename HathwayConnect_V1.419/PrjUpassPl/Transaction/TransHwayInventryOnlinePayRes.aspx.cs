...
{
    public partial class TransHwayInventryOnlinePayRes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //int intorderid;
            Master.PageHeading = "Inventory Online Payment Response";
            ...
            if (!IsPostBack)
            {
                try
                {
                    if (Request.QueryString["Response"].ToString() != "")
                    {
                        ...
                        {
                            Response.Redirect("http://hathwayconnect.com/HwayConnect/Transaction/HwayTransInventryOnlinePayment.aspx", false);
