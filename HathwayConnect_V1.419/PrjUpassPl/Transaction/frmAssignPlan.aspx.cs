...
{
    public partial class frmAssignPlan : System.Web.UI.Page
    {
        string strerror = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.PageHeading = "Pack Management";
            Session["pagenos"] = "0";
        ...
        protected string dataTableBuilder(DataTable dt, string[] arr_data, string plan_type_flag)
        {
            ...
            foreach (string plan_data in arr_data)
            {
                ...
                {
                    //14
                    tempDr["BD_PRICE"] = plan_details_arr[14];
                    tempDr["SD_Count"] = plan_details_arr[15];
                    tempDr["HD_Count"] = plan_details_arr[16];
                    tempDr["Total_Count"] = plan_details_arr[17];
                }
            ...
            try
            {
                if (ActivePOIDs != "" && ActivePOIDs != null)
                {
                    ViewState["ActivePOIDs"] = Convert.ToString(ViewState["ActivePOIDs"]) + "," + ActivePOIDs.TrimEnd(',');
                }
            }
            catch (Exception)
            {

                ViewState["ActivePOIDs"] = ActivePOIDs.TrimEnd(',');
            }
            return poid_list;
        }//shri
        ...
        protected void bindAllGrids(string service_str)
        {
            ...
            {
                nullFOCViewState();
                ViewState["ActivePOIDs"] = null;
                ViewState["Changefoccheck"] = null;
                ViewState["ActiveChannelCount"] = 0;
                ...
                if (ViewState["Deactivate"].ToString() == "Y")
                {
                ...
                {
                    lbactive.Visible = false; lbdeactive.Visible = false; btnDeact.Visible = false; btnAct.Visible = false;
                }
                if (ServiceStatus == "IA")
                {
                ...
                GetDiscountofLCO();
                ViewState["ActiveBasePrice"] = "0";
                ViewState["ActiveLCOPrice"] = "0";
                ViewState["ActiveBCPrice"] = "0";
                ViewState["ActiveChannelCount"] = "0";
                ...
                if (sortedDT.Rows.Count > 0)
                {
                    ...
                    dv1.RowFilter = "expiry='" + sortedDT.Rows[0]["expiry"].ToString() + "'";
                    DataTable sortedDTfinal = dv1.ToTable();

                    if (sortedDT.Rows[0]["plan_status"].ToString().ToUpper() == "ACTIVE")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            dtBasicPlans.ImportRow(sortedDT.Rows[0]);
                        }
                        if (basic_poids == "'0'")
                        {
                            dtBasicPlans.Rows.Clear();
                ...
                for (int i = 0; i < grdCartefree.Rows.Count; i++)
                {
                    ...
                    //--
                    Button lbALRenewal = (Button)grdCarte.Rows[i].Cells[8].FindControl("lbALRenewal");
                    Button lbALChange = (Button)grdCarte.Rows[i].Cells[8].FindControl("lbALChange");
                    Button lbALCancel = (Button)grdCarte.Rows[i].Cells[8].FindControl("lbALCancel");
                    if (ViewState["change"].ToString() == "Y")
                    {
                        //lbALChange.Visible = true;
                    ...
                    if (ViewState["renew"].ToString() == "Y")
                    {
                        lbALRenewal.Visible = true;
                    }
                    else
                    {
                        lbALRenewal.Visible = false;
                    }
                    if (ViewState["cancel"].ToString() == "Y")
                    {
                        lbALCancel.Visible = true;
                    }
                    else
                    {
                    ...
                    //--
                    //--
                    HiddenField hdnChannelCount = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnChannelCount");
                    HiddenField hdnBasePrice = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnBasicCustPrice");
                    HiddenField hdnLCOPrice = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnBasicLcoPrice");
                    HiddenField hdnBCPrice = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnBCPrice");
                    ViewState["ActiveBasePrice"] = (Convert.ToDouble(ViewState["ActiveBasePrice"].ToString()) + Convert.ToDouble(hdnBasePrice.Value));
                    ViewState["ActiveLCOPrice"] = (Convert.ToDouble(ViewState["ActiveLCOPrice"].ToString()) + Convert.ToDouble(hdnLCOPrice.Value));
                    ViewState["ActiveBCPrice"] = (Convert.ToDouble(ViewState["ActiveBCPrice"].ToString()) + Convert.ToDouble(hdnBCPrice.Value));
                    ViewState["ActiveChannelCount"] = (Convert.ToInt32(ViewState["ActiveChannelCount"].ToString()) + Convert.ToInt32(hdnChannelCount.Value));
                    //--
                }
                ...
                for (int i = 0; i < grdCarte.Rows.Count; i++)
                {
                    ...
                    //--
                    HiddenField hdnChannelCount = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnChannelCount");
                    HiddenField hdnBasePrice = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnALCustPrice");
                    HiddenField hdnLCOPrice = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnALLcoPrice");
                    HiddenField hdnBCPrice = (HiddenField)grdCarte.Rows[i].Cells[8].FindControl("hdnBCPrice");
                    ViewState["ActiveBasePrice"] = (Convert.ToDouble(ViewState["ActiveBasePrice"].ToString()) + Convert.ToDouble(hdnBasePrice.Value));
                    ViewState["ActiveLCOPrice"] = (Convert.ToDouble(ViewState["ActiveLCOPrice"].ToString()) + Convert.ToDouble(hdnLCOPrice.Value));
                    ViewState["ActiveBCPrice"] = (Convert.ToDouble(ViewState["ActiveBCPrice"].ToString()) + Convert.ToDouble(hdnBCPrice.Value));
                ...
                for (int i = 0; i < grdBasicPlanDetails.Rows.Count; i++)
                {
                    ...
                    Button lnkBAlign = (Button)grdBasicPlanDetails.Rows[i].Cells[8].FindControl("lnkBAlign");
                    ...
                    else
                    {
                        ...
                        //---
                        //--
                        HiddenField hdnChannelCount = (HiddenField)grdBasicPlanDetails.Rows[i].Cells[8].FindControl("hdnChannelCount");
                        HiddenField hdnBasePrice = (HiddenField)grdBasicPlanDetails.Rows[i].Cells[8].FindControl("hdnBasicCustPrice");
                        HiddenField hdnLCOPrice = (HiddenField)grdBasicPlanDetails.Rows[i].Cells[8].FindControl("hdnBasicLcoPrice");
                        HiddenField hdnBCPrice = (HiddenField)grdBasicPlanDetails.Rows[i].Cells[8].FindControl("hdnBCPrice");
                        ViewState["ActiveBasePrice"] = (Convert.ToDouble(ViewState["ActiveBasePrice"].ToString()) + Convert.ToDouble(hdnBasePrice.Value));
                        ViewState["ActiveLCOPrice"] = (Convert.ToDouble(ViewState["ActiveLCOPrice"].ToString()) + Convert.ToDouble(hdnLCOPrice.Value));
                        ViewState["ActiveBCPrice"] = (Convert.ToDouble(ViewState["ActiveBCPrice"].ToString()) + Convert.ToDouble(hdnBCPrice.Value));
                        ViewState["ActiveChannelCount"] = (Convert.ToInt32(ViewState["ActiveChannelCount"].ToString()) + Convert.ToInt32(hdnChannelCount.Value));
                    ...
                    else
                    {
                        ...
                        btnALPack.Visible = false;
                        lnkAddFOCPack.Visible = false;
                        //if (ViewState["FOCPack"].ToString() == "Y")
                        //{
                        //    lnkAddFOCPack.Visible = true;
                        //}
                        //else
                    ...
                    //Button btnDiscnt = (Button)grdBasicPlanDetails.Rows[i].Cells[8].FindControl("btnDiscnt");
                    //---- Added By RP on 26.12.2017
                    //if (ViewState["discount"].ToString() == "Y")
                    // {
                    //    btnDiscnt.Visible = true;
                    //}
                    //else
                    //{
                ...
                for (int i = 0; i < Grdhathwayspecial.Rows.Count; i++)
                {
                    ...
                    //---
                    //--
                    HiddenField hdnChannelCount = (HiddenField)Grdhathwayspecial.Rows[i].Cells[8].FindControl("hdnChannelCount");
                    HiddenField hdnBasePrice = (HiddenField)Grdhathwayspecial.Rows[i].Cells[8].FindControl("hdnADCustPrice");
                    HiddenField hdnLCOPrice = (HiddenField)Grdhathwayspecial.Rows[i].Cells[8].FindControl("hdnADLcoPrice");
                    HiddenField hdnBCPrice = (HiddenField)Grdhathwayspecial.Rows[i].Cells[8].FindControl("hdnBCPrice");
                    ViewState["ActiveBasePrice"] = (Convert.ToDouble(ViewState["ActiveBasePrice"].ToString()) + Convert.ToDouble(hdnBasePrice.Value));
                    ViewState["ActiveLCOPrice"] = (Convert.ToDouble(ViewState["ActiveLCOPrice"].ToString()) + Convert.ToDouble(hdnLCOPrice.Value));
                    ViewState["ActiveBCPrice"] = (Convert.ToDouble(ViewState["ActiveBCPrice"].ToString()) + Convert.ToDouble(hdnBCPrice.Value));
                    ViewState["ActiveChannelCount"] = (Convert.ToInt32(ViewState["ActiveChannelCount"].ToString()) + Convert.ToInt32(hdnChannelCount.Value));
                ...
                for (int i = 0; i < grdAddOnPlan.Rows.Count; i++)
                {
                    ...
                    //---
                    Button lnkADRenew = (Button)grdAddOnPlan.Rows[i].Cells[8].FindControl("lnkADRenew");
                    Button lnkADChange = (Button)grdAddOnPlan.Rows[i].Cells[8].FindControl("lnkADChange");
                    Button lnkADCancel = (Button)grdAddOnPlan.Rows[i].Cells[8].FindControl("lnkADCancel");
                    if (ViewState["change"].ToString() == "Y")
                    {
                        //lnkADChange.Visible = true;
                        lnkADChange.Visible = false;
                    ...
                    //---
                    //--
                    HiddenField hdnChannelCount = (HiddenField)grdAddOnPlan.Rows[i].Cells[8].FindControl("hdnChannelCount");
                    HiddenField hdnBasePrice = (HiddenField)grdAddOnPlan.Rows[i].Cells[8].FindControl("hdnADCustPrice");
                    HiddenField hdnLCOPrice = (HiddenField)grdAddOnPlan.Rows[i].Cells[8].FindControl("hdnADLcoPrice");
                    HiddenField hdnBCPrice = (HiddenField)grdAddOnPlan.Rows[i].Cells[8].FindControl("hdnBCPrice");
                    ViewState["ActiveBasePrice"] = (Convert.ToDouble(ViewState["ActiveBasePrice"].ToString()) + Convert.ToDouble(hdnBasePrice.Value));
                    ViewState["ActiveLCOPrice"] = (Convert.ToDouble(ViewState["ActiveLCOPrice"].ToString()) + Convert.ToDouble(hdnLCOPrice.Value));
                    ViewState["ActiveBCPrice"] = (Convert.ToDouble(ViewState["ActiveBCPrice"].ToString()) + Convert.ToDouble(hdnBCPrice.Value));
                    ViewState["ActiveChannelCount"] = (Convert.ToInt32(ViewState["ActiveChannelCount"].ToString()) + Convert.ToInt32(hdnChannelCount.Value));
                ...
                {
                    string planname = "";
                    planname = grdAddOnPlanReg.Rows[i].Cells[0].Text.ToString();
                    HiddenField hdnADPlanPoid = (HiddenField)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("hdnADPlanPoid");
                    Button lnkADChange = (Button)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("lnkADChange");

                    string PlanPoid = hdnADPlanPoid.Value.Trim();
                    AutoRenewAddon = AutoRenewstatus(ViewState["vcid"].ToString(), ViewState["customer_no"].ToString(), PlanPoid.ToString());
                    if (AutoRenewAddon == true)
                    {
                        grdAddOnPlanReg.Rows[i].BackColor = System.Drawing.ColorTranslator.FromHtml("#ffe6e6");
                        ((CheckBox)(grdAddOnPlanReg.Rows[i].FindControl("cbAddonAutorenew"))).Checked = true;
                        ((Label)(grdAddOnPlanReg.Rows[i].FindControl("lblAutorenew"))).Text = strAutorenewalOn;

                    }
                    else
                    {
                        ((CheckBox)(grdAddOnPlanReg.Rows[i].FindControl("cbAddonAutorenew"))).Checked = false;
                        ((Label)(grdAddOnPlanReg.Rows[i].FindControl("lblAutorenew"))).Text = "Off";
                    }

                    //---
                    Button lnkADRenew = (Button)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("lnkADRenew");
                    Button lnkADCancel = (Button)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("lnkADCancel");
                    if (ViewState["change"].ToString() == "Y")
                    {
                        // lnkADChange.Visible = true;
                        lnkADChange.Visible = false;
                    ...
                    //---
                    //--
                    HiddenField hdnChannelCount = (HiddenField)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("hdnChannelCount");
                    HiddenField hdnBasePrice = (HiddenField)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("hdnADCustPrice");
                    HiddenField hdnLCOPrice = (HiddenField)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("hdnADLcoPrice");
                    HiddenField hdnBCPrice = (HiddenField)grdAddOnPlanReg.Rows[i].Cells[8].FindControl("hdnBCPrice");
                    ViewState["ActiveBasePrice"] = (Convert.ToDouble(ViewState["ActiveBasePrice"].ToString()) + Convert.ToDouble(hdnBasePrice.Value));
                    ViewState["ActiveLCOPrice"] = (Convert.ToDouble(ViewState["ActiveLCOPrice"].ToString()) + Convert.ToDouble(hdnLCOPrice.Value));
                    ViewState["ActiveBCPrice"] = (Convert.ToDouble(ViewState["ActiveBCPrice"].ToString()) + Convert.ToDouble(hdnBCPrice.Value));
                    ViewState["ActiveChannelCount"] = (Convert.ToInt32(ViewState["ActiveChannelCount"].ToString()) + Convert.ToInt32(hdnChannelCount.Value));
                ...
                if (ViewState["retrack"].ToString() == "Y")
                {
                    BtnRetract.Visible = true;
                }
                else
                ...
                if (lblBasicPlan.Visible == true || lblhathwayspecial.Visible == true || lblAddonPlan.Visible == true || lblAlacartePlan.Visible == true)
                {
                    ...
                    if (ViewState["cancel"].ToString() == "Y")
                    {
                        btnBulkCancel.Visible = true;
                    }
                    else
                    {
                        btnBulkCancel.Visible = false;
                    }
                    if (ViewState["autorenew"].ToString() == "Y")
                    {
                        btnAutoRenewal.Visible = true;
                    }
                    else
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (apiResponse != "")
                {
                    ...
                    string CustBOUQUET_ID = lstResponse[18];
                    lblCustBOUQUET_ID.Text = CustBOUQUET_ID;
                    ...
                    if (ViewState["stbswap"].ToString() == "Y")
                    {
                        btnFaulty.Visible = true;
                    }
                    else
                    {
                        btnFaulty.Visible = false;
                    }
                    if (ViewState["Terminate"].ToString() == "Y")
                    {
                    ...
                    if (ViewState["custmodify"].ToString() == "Y")
                    {
                        btnModifyCust.Visible = true;
                    }
                    else
                    {
                        btnModifyCust.Visible = false;
                    }
                    if (ViewState["FOCPack"].ToString() == "Y")
                    {
                        lnkManageExPlan.Visible = true;
                    }
                    else
                    {
                        lnkManageExPlan.Visible = false;
                    }
                    //---
                }
                else
        ...
        public String callAPI(string Request, string request_code)
        {
            try
            {
                ...
                try
                {
                    try
                    {
                        Urllist = System.IO.File.ReadAllText(@"C:\temp\URL_list.txt");
                    }
                    catch (Exception)
                    {
                        Urllist = ConfigurationManager.AppSettings["Url_list"].ToString();
                    }
                }
                catch { }
                string[] lines;
                ...
                try
                {
                    OBRMSERVER = ConfigurationSettings.AppSettings["OBRMSERVER"].ToString().Trim();
                }
                catch
                {
                    OBRMSERVER = "24";
        ...
        protected void lnkADRenew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dtRenew.Columns.Add(new DataColumn("refund_amt", typeof(double)));
                dtRenew.Columns.Add(new DataColumn("days_left"));
                dtRenew.Columns.Add(new DataColumn("refund_lcoamt", typeof(double)));
                DataTable sortedDT = (DataTable)ViewState["vcdetail"];
                DataTable myResultSet = sortedDT.Select("TAB_FLAG='" + hdntag.Value + "'").CopyToDataTable();
                ...
                string strNCFPlanList = objPlan.Check_NFCPlan(Session["lco_username"].ToString(), selected_service_str, ViewState["cityid"].ToString(), ViewState["customer_no"].ToString(), Session["operator_id"].ToString(), strPLANPOISs, "R", vc_id);
                ...
                if (strPlanlist[0] == "9999")
                {
                    if (strPlanlist[1] == "Y")
                    {
                        ...
                        dt = objPlan.getNCFPlanDetails(Session["lco_username"].ToString(), strPlanlist[2].ToString(), ViewState["JVFlag"].ToString(), ViewState["cityid"].ToString(), Session["dasarea"].ToString(), Convert.ToString(Session["operator_id"]), Convert.ToString(Session["JVNO"]));
                ...
                {
                    popAdd.Hide();
                    msgboxstr("Failed in NCF Calcutaion ...");
                }
                ...
                {
                    GrdRenewConfrim.Columns[2].Visible = false;
                    GrdRenewConfrim.Columns[3].Visible = false;
                    GrdRenewConfrim2.Columns[2].Visible = false;
                    GrdRenewConfrim2.Columns[3].Visible = false;
                    GrdRenewConfrim.Columns[4].Visible = false;
                    GrdRenewConfrim2.Columns[4].Visible = false;
        ...
        protected void lnkADCancel_Click(object sender, EventArgs e)
        {
            ...
            dtRenew.Columns.Add(new DataColumn("days_left"));
            dtRenew.Columns.Add(new DataColumn("refund_lcoamt", typeof(double)));
            dtRenew.Rows.Add(htData["planname"], htData["custprice"], htData["lcoprice"], 0, htData["custprice"], htData["activation"], htData["expiry"], htData["planpoid"], htData["dealpoid"], htData["activation"], "N", htData["refund_amt"], htData["days_left"], htData["refund_lcoamt"]);
            ...
            else
            {
                ...
                else
                {
                    ...
                    dtRenew.Rows[0]["refund_amt"] = conResult_arr[1];
                    dtRenew.Rows[0]["days_left"] = conResult_arr[0];


                    try
                    {
                        htData["refund_lcoamt"] = conResult_arr[2];
                        dtRenew.Rows[0]["refund_lcoamt"] = conResult_arr[2];
                    }
                    catch
                    {
                        htData["refund_lcoamt"] = "0";
                        dtRenew.Rows[0]["refund_lcoamt"] = "0";
                    }
                    ...
                    if (dtRenew.Rows.Count > 0)
                    {
                        GrdRenewConfrim.Columns[2].Visible = true;
                        GrdRenewConfrim.Columns[3].Visible = true;
                        GrdRenewConfrim2.Columns[2].Visible = true;
                        GrdRenewConfrim2.Columns[3].Visible = true;
                        GrdRenewConfrim.Columns[4].Visible = true;
                        GrdRenewConfrim2.Columns[4].Visible = true;
                        GrdRenewConfrim.Columns[1].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("CUST_PRICE")).Sum().ToString();
                        GrdRenewConfrim2.Columns[1].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("CUST_PRICE")).Sum().ToString();
                        GrdRenewConfrim.Columns[2].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("refund_lcoamt")).Sum().ToString();
                        GrdRenewConfrim2.Columns[2].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("refund_lcoamt")).Sum().ToString();
                        GrdRenewConfrim.Columns[3].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("refund_amt")).Sum().ToString();
                        GrdRenewConfrim2.Columns[3].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("refund_amt")).Sum().ToString();
                        GrdRenewConfrim.DataSource = dtRenew;
                        GrdRenewConfrim.DataBind();
                        GrdRenewConfrim2.DataSource = dtRenew;
                        GrdRenewConfrim2.DataBind();
        ...
        protected void lnkALCancel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    htData["refund_lcoamt"] = conResult_arr[2].Replace("Rs.", "");
                    dtRenew.Rows[0]["refund_lcoamt"] = conResult_arr[2].Replace("Rs.", "");
                }
                catch
                {
                    htData["refund_lcoamt"] = "0";
        ...
        protected void btnAddPlan1_Click(object sender, EventArgs e)
        {
            ...
            if (grdBasicPlanDetails.Rows.Count > 0)
            {
                foreach (GridViewRow gvrow in grdBasicPlanDetails.Rows)
                {
                    ...
                    if (hdnPlanType.Value == "B")
                    {
                        Session["BasicExpiry"] = hdnBasicExpiry.Value;
                        Session["BasicPoid"] = hdnBasicPlanPoid.Value;
                    }
                }
            }
            ...
            if ((Session["BasicExpiry"]).ToString() != "")
            {
                // popAlignDate.Show();
        ...
        protected void btnAddPlan_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gr in grdPlanChan.Rows)
            {
                ...
                try
                {
                    if (ChkPlanAdd.Checked)
                    {
                        ...
                        try
                        {
                            htData["Alignflag"] = Session["Alignflag"].ToString();
                            htData["BasicExpiry"] = Session["BasicExpiry"];
                            htData["BasicPoid"] = Session["BasicPoid"];
                        }
                        catch (Exception)
                        {
                            htData["Alignflag"] = "N";
                        ...
                        try
                        {
                            htData["ActivePlanPoid"] = Convert.ToString(ViewState["ActivePOIDs"]).TrimStart(',');
                        }
                        catch (Exception)
                        {
                            htData["ActivePlanPoid"] = "";
                        }
                        //---08072019
            ...
            try
            {
                ...
                ViewState["strPLANPOISs"] = null;
                ViewState["strPLANPOISs"] = strPLANPOISs;
                Cls_Business_TxnAssignPlan objPlan = new Cls_Business_TxnAssignPlan();
                //FileLogTextChange1(vc_id, "Calling NCF Procedure", selected_service_str, strPLANPOISs);
                string strNCFPlanList = objPlan.Check_NFCPlan(Session["lco_username"].ToString(), selected_service_str, ViewState["cityid"].ToString(), ViewState["customer_no"].ToString(), Session["operator_id"].ToString(), strPLANPOISs, "A", vc_id);
                ...
                if (strPlanlist[0] == "9999")
                {
                    if (strPlanlist[1] == "Y")
                    {
                        ...
                        else
                        {
                            ...
                            dt = objPlan.getNCFPlanDetails(Session["lco_username"].ToString(), strPlanlist[2].ToString(), ViewState["JVFlag"].ToString(), ViewState["cityid"].ToString(), Session["dasarea"].ToString(), Convert.ToString(Session["operator_id"]), Convert.ToString(Session["JVNO"]));
                            //--- adding Basic
                            Boolean chkngc1 = false;
                            for (int i = 0; i < dt.Rows.Count; i++)
                            {
                                if (dt.Rows[i][0].ToString().Contains("NCF 1 30d") == true)
                                {
                                    chkngc1 = true;
                                    break;
                                }
                            ...
                            if (chkngc1 == true)
                            {
                                ...
                                if (ViewState["JVFlag"].ToString() == "Y")
                                {
                                    ...
                                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                                                   " a.cityid, a.company_code, a.insby, a.insdt,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.broad_name, a.genre_type,a.var_plan_freeflag  FROM VIEW_LCOJVPLAN_FETCH_ALL a " +
                                                   " where a.cityid =" + city + " and a.plan_type='B'" +
                                                   " and a.plan_poid not in (" + basic_poids + ")  and lcocode=" + Session["lcoid"].ToString() + " and  a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                                                   ...
                                                   " a.cityid, a.company_code, a.insby, a.insdt,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.broad_name, a.genre_type,a.var_plan_freeflag  FROM VIEW_JVPLAN_FETCH_ALL a " +
                                                   " where a.cityid =" + city + " and a.plan_type='B'" +
                                                   " and a.plan_poid not in (" + basic_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                                                   whestring + hd_where_clause +
                                                   " and not EXISTS (select * from  VIEW_LCOJVPLAN_FETCH_ALL where plan_name=a.plan_name and  plan_poid=a.plan_poid and lcocode=" + Session["lcoid"].ToString() + ")  " +
                                ...
                                {
                                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                                               " a.cityid, a.company_code, a.insby, a.insdt,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.broad_name, a.genre_type,a.var_plan_freeflag  FROM VIEW_LCOPLAN_FETCH_ALL a " +
                                               " where a.cityid =" + city + " and a.plan_type='B'" +
                                               " and a.plan_poid not in (" + basic_poids + ")  and lcocode=" + Session["lcoid"].ToString() + " and  a.dasarea='" + Session["dasarea"].ToString() + "'" +
                                               whestring + hd_where_clause +
                                               " union SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                                               " a.cityid, a.company_code, a.insby, a.insdt,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.broad_name, a.genre_type,a.var_plan_freeflag  FROM VIEW_PLAN_FETCH_ALL a " +
                                               " where a.cityid =" + city + " and a.plan_type='B'" +
                                        " and a.plan_poid not in (" + basic_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                                        whestring + hd_where_clause +
                                        " and not EXISTS (select * from  VIEW_LCOPLAN_FETCH_ALL where plan_name=a.plan_name and  plan_poid=a.plan_poid and lcocode=" + Session["lcoid"].ToString() + ")  " +
                                        " order by plan_name asc";
                                }
                                ...
                                if (TblPlans.Rows.Count > 0)
                                {
                                    ...
                                    grdBasicADD.DataSource = TblPlans;
                                    grdBasicADD.DataBind();
                                }
                                else
                                {
                                    Label168.Visible = true;
                                    grdBasicADD.DataSource = null;
                                    grdBasicADD.DataBind();
                                }
                                StatbleDynamicTabs();
                                popBasicAdd.Show();
                ...
                GrdaddplanConfrim.DataSource = null;
                GrdaddplanConfrim.DataBind();
                ViewState["ADDINGChannelCount"] = 0;
                ViewState["ADDINGCustPrice"] = 0;
                ViewState["ADDINGLCOPrice"] = 0;
                ViewState["ADDINGBCPrice"] = 0;
                if (TblNCFPlanAddfinal.Rows.Count > 0 || TblPlanAddfinal.Rows.Count > 0)
                {
                    if (TblPlanAddfinal.Rows.Count > 0)
                    {
                        ...
                        ViewState["ADDINGCustPrice"] = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("CUST_PRICE")).Sum().ToString();
                        ViewState["ADDINGLCOPrice"] = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("LCO_PRICE")).Sum().ToString();
                        ViewState["ADDINGBCPrice"] = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("BC_PRICE")).Sum().ToString();
                        ViewState["ADDINGChannelCount"] = TblPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("ChannelCount")).Sum().ToString();
                    ...
                    else if (TblNCFPlanAddfinal.Rows.Count > 0)
                    {
                        ...
                        ViewState["ADDINGCustPrice"] = TblNCFPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("CUST_PRICE")).Sum().ToString();
                        ViewState["ADDINGLCOPrice"] = TblNCFPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("LCO_PRICE")).Sum().ToString();
                        ViewState["ADDINGBCPrice"] = TblNCFPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("BC_PRICE")).Sum().ToString();
                        ViewState["ADDINGChannelCount"] = TblNCFPlanAddfinal.AsEnumerable().Select(x => x.Field<Double>("ChannelCount")).Sum().ToString();
                        GrdaddplanConfrim.DataSource = TblNCFPlanAddfinal;
                        GrdaddplanConfrim.DataBind();
                    }
                    lblExistBaseTotal.Text = Convert.ToString(ViewState["ActiveBasePrice"]);
                    lblOverallBaseTotal.Text = Convert.ToString(Convert.ToDouble(ViewState["ActiveBasePrice"]) + Convert.ToDouble(ViewState["ADDINGCustPrice"]));
                    lblExistLCOTotal.Text = Convert.ToString(ViewState["ActiveLCOPrice"]);
                    lblOverallLCOTotal.Text = Convert.ToString(Convert.ToDouble(ViewState["ActiveLCOPrice"]) + Convert.ToDouble(ViewState["ADDINGLCOPrice"]));
                    lblExistBCTotal.Text = Convert.ToString(ViewState["ActiveBCPrice"]);
                    lblOverallBCTotal.Text = Convert.ToString(Convert.ToDouble(ViewState["ActiveBCPrice"]) + Convert.ToDouble(ViewState["ADDINGBCPrice"]));
                    lblExistChannelTotal.Text = Convert.ToString(ViewState["ActiveChannelCount"]);
                    lblOverallChannelTotal.Text = Convert.ToString(Convert.ToInt32(ViewState["ActiveChannelCount"]) + Convert.ToInt32(ViewState["ADDINGChannelCount"]));
        ...
        //---
        protected void btnBasicADDPlan_Click(object sender, EventArgs e)
        {
            DataTable TblPlanAddfinal = new DataTable();
            TblPlanAddfinal.Columns.Add("plan_name");
            TblPlanAddfinal.Columns.Add("cust_price", typeof(double));
            ...
            ViewState["SearchedPoid"] = null;
            ViewState["SearchedPlanName"] = null;
            foreach (GridViewRow gr in grdBasicADD.Rows)
            {
                HiddenField hdnplanaddPlanPoid = (HiddenField)gr.Cells[2].FindControl("hdnplanaddPlanPoid");
                HiddenField hdnplanaddDealPoid = (HiddenField)gr.Cells[2].FindControl("hdnplanaddDealPoid");
                HiddenField hdnplanaddproducteId = (HiddenField)gr.Cells[2].FindControl("hdnplanaddproducteId");
                ...
                try
                {
                    if (ChkPlanAdd.Checked)
                    {
                        ...
                        Double HDCount = Convert.ToDouble(gr.Cells[6].Text.Trim()) * 2;
                        Double ChannelCount = SDCount + HDCount;
                        ViewState["strPLANPOISs"] += hdnplanaddPlanPoid.Value + ",";
                        if (hdnplanaddplantype.Value.Trim() == "B")
                        {
                            ViewState["BasciaddcancelFOC"] = "Y";
                        ...
                        TblNCFPlanAddfinal.Rows.Add(Plan_name, custprice, lcoprice, BCprice, 0, 0, ChannelCount, hdnplanaddPlanPoid.Value.Trim(), hdnplanaddDealPoid.Value.Trim(),
                       hdnplanaddproducteId.Value.Trim(), hdnplanaddplantype.Value.Trim(), "N", "Valid Plan for Add", "9999", "");
                    }
                }
                catch (Exception ex)
                {
            ...
            if (TblNCFPlanAddfinal.Rows.Count == 0)
            {
                msgboxstr("Please select Plan");
                StatbleDynamicTabs();
                popBasicAdd.Show();
            ...
            TblPlanAddfinal = (DataTable)ViewState["TblPlanAddfinal"];
            for (int i = 0; i < TblPlanAddfinal.Rows.Count; i++)
            {
                TblNCFPlanAddfinal.Rows.Add(TblPlanAddfinal.Rows[i][0].ToString(), TblPlanAddfinal.Rows[i][1].ToString(), TblPlanAddfinal.Rows[i][2].ToString(), TblPlanAddfinal.Rows[i][3].ToString(), TblPlanAddfinal.Rows[i][4].ToString(), TblPlanAddfinal.Rows[i][5].ToString(), TblPlanAddfinal.Rows[i][6].ToString(), TblPlanAddfinal.Rows[i][7].ToString(), TblPlanAddfinal.Rows[i][8].ToString(), TblPlanAddfinal.Rows[i][9].ToString(), TblPlanAddfinal.Rows[i][10].ToString(), TblPlanAddfinal.Rows[i][11].ToString(), TblPlanAddfinal.Rows[i][12].ToString(), TblPlanAddfinal.Rows[i][13].ToString(), TblPlanAddfinal.Rows[i][13].ToString());
            }
            ...
            try
            {
                ...
                Cls_Business_TxnAssignPlan objPlan = new Cls_Business_TxnAssignPlan();
                //FileLogTextChange1(vc_id, "Calling NCF Procedure", selected_service_str, strPLANPOISs);
                string strNCFPlanList = objPlan.Check_NFCPlan(Session["lco_username"].ToString(), selected_service_str, ViewState["cityid"].ToString(), ViewState["customer_no"].ToString(), Session["operator_id"].ToString(), Convert.ToString(ViewState["strPLANPOISs"]).TrimEnd(','), "A", vc_id);
                //FileLogTextChange1(vc_id, "Calling NCF Procedure", strNCFPlanList, "");
                string[] strPlanlist = strNCFPlanList.Split('$');
                if (strPlanlist[0] == "9999")
                {
            ...
            if (TblNCFPlanAddfinal.Rows.Count > 0 || TblPlanAddfinal.Rows.Count > 0)
            {
                ...
                lblExistChannelTotal.Text = Convert.ToString(ViewState["ActiveChannelCount"]);
                lblOverallChannelTotal.Text = Convert.ToString(Convert.ToInt32(ViewState["ActiveChannelCount"]) + Convert.ToInt32(ViewState["ADDINGChannelCount"]));
                Session["ChannelCount"] = Convert.ToString(ViewState["ADDINGChannelCount"]);
                popaddplanconfirm.Show();
            }
            else
            {
        ...
        protected string callGetProviConfirmAddplan(Hashtable htData, string flag)
        {
            ...
            if (htData["Alignflag"] != null)
            {
                ht["Alignflag"] = htData["Alignflag"];
            }
            else
            {
            ...
            if (htData["BasicExpiry"] != null)
            {
                ht["BasicExpiry"] = htData["BasicExpiry"];
            }
            else
            {
            ...
            if (htData["BasicPoid"] != null)
            {
                ht["BasicPoid"] = htData["BasicPoid"];
            }
            else
            {
            ...
            try
            {
                ht["ActivePlanPoid"] = Convert.ToString(ViewState["ActivePOIDs"]).TrimStart(',');
            }
            catch (Exception)
            {
                ht["ActivePlanPoid"] = "";
            ...
            */
            try
            {
                ...
                foreach (GridViewRow gr in GrdaddplanConfrim.Rows)
                {
                    ...
                    HiddenField hdnfoctype = (HiddenField)gr.Cells[3].FindControl("hdnfoctype");//hdnCode
                    ...
                    if (hdnCode.Value == "9999")
                    {
                        ...
                        if (!HttpUtility.HtmlDecode(gr.Cells[0].Text).Contains("NCF 1 30d"))
                        {
                        ...
                        try
                        {
                            ht["Alignflag"] = Session["Alignflag"].ToString();
                            ht["BasicExpiry"] = Session["BasicExpiry"];
                            ht["BasicPoid"] = Session["BasicPoid"];
                        }
                        catch (Exception)
                        {
                            ht["Alignflag"] = "N";
            ...
            if (radPlanAD.Checked)
            {
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                       ...
                       " and a.plan_poid not in (" + addon_poids + ")" +
                       " and  a.plan_poid2 in (" + basic_poids + ") and jvno='" + Convert.ToString(Session["JVNO"]) + "'";
                }
                else
                {
                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                ...
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    str = " (SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price " +
                            ...
                            " where a.plan_type='AL' and a.cityid ='" + city + "' and upper(a.plan_name) like upper('" + search_text + "%')  " +
                             " and a.plan_poid not in (" + ala_poids + ") and a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                             " ) minus  " +
                             " ( " +
                             " SELECT c.num_plan_id,c.var_plan_name,c.num_plan_custprice,c.var_plan_planpoid,c.var_plan_plantype,c.var_plan_dealpoid,c.num_plan_lcoprice " +
            ...
            else if (radPlanBasic.Checked)
            {
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                       ...
                       " where a.cityid ='" + city + "' and a.plan_type='B'" +
                       " and upper(a.plan_name) like upper('" + search_text + "') and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                       " and a.plan_poid not in (" + basic_poids + ") and jvno='" + Convert.ToString(Session["JVNO"]) + "'";
                }
                else
                {
                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
            ...
            if (radPlanAD.Checked)
            {
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
                      ...
                      " and a.plan_poid not in (" + addon_poids + ") and jvno='" + Convert.ToString(Session["JVNO"]) + "'";
                }
                else
                {
                    str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, " +
            ...
            else if (radPlanAL.Checked)
            {
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    str = " (SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price " +
                          ...
                          " where a.plan_type='AL' and a.cityid ='" + city + "' and upper(a.plan_name) like upper('" + search_text + "%')  " +
                           " and a.lcocode='" + Session["lcoid"].ToString() + "' and a.plan_poid not in (" + ala_poids + ") and a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                           " ) minus  " +
                           " ( " +
                           " SELECT c.num_plan_id,c.var_plan_name,c.num_plan_custprice,c.var_plan_planpoid,c.var_plan_plantype,c.var_plan_dealpoid,c.num_plan_lcoprice " +
        ...
        protected void processTransactionValidfirst()
        {
            try
            {
                ...
                if (ViewState["ServicePoid"] != null && ViewState["accountPoid"] != null)
                {
                    ...
                    try
                    {
                        ht["AlignExpiryFlag"] = Session["Alignflag"].ToString();
                        ht["BasicPlanExpairy"] = Session["BasicExpiry"];
                        ht["BasicExpairyPlanID"] = Session["BasicPoid"];
                    }
                    catch (Exception)
                    {
        ...
        // Change Plan .....
        protected void processChangeTransaction_New()
        {
            try
            {
                ViewState["ErrorMessage"] = null;
                ...
                //if cancel and renew
                plan_poid = Convert.ToString(htPlanData["planid"].ToString());
                Oldplan_poid = htPlanData["Old_planid"].ToString();
                activation_date = htPlanData["actdt"].ToString();
                expiry_date = htPlanData["expirydt"].ToString();
                ...
                if (ViewState["ServicePoid"] != null && ViewState["accountPoid"] != null)
                {
                    ...
                    ht.Add("bucket1foc", Convert.ToString(ViewState["bucket1foc"]));
                    ht.Add("bucket2foc", Convert.ToString(ViewState["bucket2foc"]));
                    ht.Add("strPlanList", Convert.ToString(ViewState["strPlanList"]));
                    Cls_Business_TxnAssignPlan obj = new Cls_Business_TxnAssignPlan();
                    string response = obj.ValidateProvTrans(ht);
                ...
                //OBRM call to get response...
                // Request = _username + "$" + Request;
                // if (transaction_action == "R")
                //{
                Request = ViewState["accountPoid"].ToString() + "$" + ViewState["ServicePoid"].ToString() + "$" + htPlanData["dealpoid"] + "$" + htPlanData["packageid"] + "$" + Oldplan_poid + "$" + plan_poid;
                //}
                //else
                //{
                //    ViewState["ErrorMessage"] = "Something went wrong while transaction.";
                ...
                ht.Add("response", api_response);
                ht.Remove("Oldplanid");
                Oldplan_poid = htPlanData["Old_planid"].ToString() + "$" + htPlanData["expirydt"].ToString() + "#" + Convert.ToString(ViewState["strPlanList"]);
                ht.Add("Oldplanid", Oldplan_poid.TrimEnd('#'));
                //----------    for child TV discount ... added by RP on 09052019
                ht.Add("BoxType", Session["BoxType"]);
                ht.Add("TVConnection", Session["TVConnection"]);
                //----------
                Cls_Business_TxnAssignPlan obj1 = new Cls_Business_TxnAssignPlan();
                string resp = obj1.ProvChangeTransRes(ht); // "9999";
                string[] finalres = resp.Split('$');
                if (finalres[0] == "9999")
                {
                    //msgboxstr_refresh("Transaction successful : " + obrm_msg);
        ...
        protected void radPlanAll_CheckedChanged(object sender, EventArgs e) //added by vivek 04-Jan-2016
        {
            ...
            try
            {
                ...
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    ...
                    //}
                    //str += " ) ";
                    str += hd_where_clause + "  and jvno='" + Convert.ToString(Session["JVNO"]) + "' ";//and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                ...
                if (TblPlans.Rows.Count > 0)
                {
                    ...
                    string StrQry = "SELECT  distinct(a.BROAD_NAME) BROAD_NAME,a.BROAD_NAME BROAD_value FROM  view_lcopre_plan_fetchnew a WHERE a.plan_type not in ('B','HSP') AND a.cityid = '" + city + "'  AND a.dasarea = '" + Session["dasarea"].ToString() + "' and broad_name is not null";//AND a.payterm = '" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                    ...
                    string StrQry2 = "SELECT  distinct(a.genre_type) genre_type,a.genre_type genre_value FROM  view_lcopre_plan_fetchnew a WHERE a.plan_type not in ('B','HSP') AND a.cityid = '" + city + "'  AND a.dasarea = '" + Session["dasarea"].ToString() + "' and genre_type is not null";//AND a.payterm = '" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (ViewState["JVFlag"].ToString() == "Y")
                    {
                        ...
                        str += "  where a.cityid ='" + city + "' and a.PLAN_TYPE='" + PlanTypenew + "' ";
                        str += "  and a.plan_poid not in (" + addon_poids + ") and a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "' " + hd_where_clause;
                        //str += " and  a.plan_poid2 in (" + basic_poids + ")";
                        //str += "  and var_plan_freeflag <> 'Y'";
                        /* str += "  and (  addon_plantype is null ";
                         foreach (string st in addon_poidsarr)
                    ...
                    if (TblPlans.Rows.Count > 0)
                    {
                        ...
                        default_itmBC.Text = "All";
                        default_itmBC.Value = "0";
                        string StrQry = "SELECT  distinct(a.BROAD_NAME) BROAD_NAME,a.BROAD_NAME BROAD_value FROM  view_lcopre_plan_fetchnew a WHERE a.plan_type not in ('B','HSP','AL') AND a.cityid = '" + city + "'  AND a.dasarea = '" + Session["dasarea"].ToString() + "' and broad_name is not null";//AND a.payterm = '" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                        Cls_Helper ObjHelper = new Cls_Helper();
                        DataTable dtBCData = null;
                        dtBCData = ObjHelper.GetDataTable(StrQry);
            ...
            try
            {
                ...
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    ...
                    str = " SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price,a.product_poid,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.BROAD_NAME, a.GENRE_TYPE,a.var_plan_freeflag " +
                                          ...
                                          " and a.plan_poid not in (" + ala_poids + ") " +
                                          "   and a.dasarea='" + Session["dasarea"].ToString() + "'and jvno='" + Convert.ToString(Session["JVNO"]) + "' and lcocode=" + Session["lcoid"].ToString() +//and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                                          ...
                                          "  and a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +//and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "' 
                ...
                if (TblPlans.Rows.Count > 0)
                {
                    ...
                    default_itmBC.Text = "All";
                    default_itmBC.Value = "0";
                    string StrQry = "SELECT  distinct(a.BROAD_NAME) BROAD_NAME,a.BROAD_NAME BROAD_value FROM  view_lcopre_plan_fetchnew a WHERE a.plan_type in ('AL') AND a.cityid = '" + city + "'  AND a.dasarea = '" + Session["dasarea"].ToString() + "' and broad_name is not null";//AND a.payterm = '" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                    ...
                    string StrQry2 = "SELECT  distinct(a.genre_type) genre_type,a.genre_type genre_value FROM  view_lcopre_plan_fetchnew a WHERE a.plan_type in ('AL') AND a.cityid = '" + city + "'  AND a.dasarea = '" + Session["dasarea"].ToString() + "' and genre_type is not null";//AND a.payterm = '" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                    DataTable dtGenerData = null;
                    dtGenerData = ObjHelper.GetDataTable(StrQry2);
                    ddlGener.DataSource = dtGenerData;
                    ddlGener.DataValueField = "genre_value";
        ...
        protected void lnkBChange_Click(object sender, EventArgs e)
        {
            ...
            ViewState["PlanName"] = hdnBasicPlanName.Value;
            ViewState["expdt"] = hdnBasicExpiry.Value;
            ViewState["Planid"] = hdnBasicPlanPoid.Value;
            ViewState["Old_Planid"] = hdnBasicPlanPoid.Value;
        ...
        protected void btnChangePlanContinue_click(object sender, EventArgs e)
        {
            ddlChangeplan("HSP", ViewState["PayTerm"].ToString());
            mpeChangeplan.Hide();
            popchange.Show();
            StatbleDynamicTabs();
        }
        ...
        protected void lnkADChange_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hdnBasicExpiry = (HiddenField)grdAddOnPlan.FindControl("hdnADExpiry");
            ViewState["PlanName"] = hdnADPlanName.Value;
            ViewState["expdt"] = hdnBasicExpiry.Value;
            ViewState["Planid"] = hdnADPlanPoid.Value;
            ViewState["Old_Planid"] = hdnADPlanPoid.Value;
        ...
        public void ddlChangeplanLco(string planType, string PayTerm)
        {
            ...
            try
            {
                ...
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    ...
                    strproviId += " where var_plan_planpoid ='" + planid + "' and var_plan_dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "' ";
                }
                else
                {
                ...
                if (planType == "B")
                {
                    if (ViewState["JVFlag"].ToString() == "Y")
                    {
                     ...
                     "  and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                        whestring + //whestringDevicetype + and a.payterm =" + PayTerm + "
                ...
                if (planType == "AD")
                {
                    ...
                    if (ViewState["JVFlag"].ToString() == "Y")
                    {
                       ...
                       " and  a.plan_poid2 in (" + basic_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                         "  and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                                //" and a.plan_proviid='" + proviId + "'" +and payterm ='" + AddOnpayterm + "'
                           " order by a.plan_name asc";
                        }
                        else
                        {
                        ...
                        " and a.PROVIID='" + proviId + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "' " +
                            " order by a.plan_name asc";
                        }
                    }
                    else
                ...
                {
                    if (Convert.ToString(ViewState["PlanName"]).Contains("NCF 1 30d") == true)
                    {
                        planType = "HSP,B";
                    }
                    if (ViewState["JVFlag"].ToString() == "Y")
                    ...
                    if (ViewState["JVFlag"].ToString() == "Y")
                    {
                        str = " select * from ( (SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price " +
                            ...
                            //and upper(a.plan_name) like upper('" + prefixText + "%')  " +
                             ...
                             " and a.proviid ='" + proviId + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "' " + //whestringDevicetype +
                             " ) minus  " +
                             " ( " +
                             " SELECT c.num_plan_id,c.var_plan_name,c.num_plan_custprice,c.var_plan_planpoid,c.var_plan_plantype,c.var_plan_dealpoid,c.num_plan_lcoprice  " +
                             " FROM aoup_lcopre_lcojvplan_def a,aoup_lcopre_plan_channel b ,aoup_lcopre_lcojvplan_def c " +
        ...
        public void ddlChangeplan(string planType, string PayTerm)
        {
            ...
            try
            {
                ...
                {
                    strproviId += " select var_plan_proviid  from aoup_lcopre_jvplan_def ";
                    strproviId += " where var_plan_planpoid ='" + planid + "' and var_plan_dasarea='" + Session["dasarea"].ToString() + "' and num_plan_jvno='" + Convert.ToString(Session["JVNO"]) + "'";
                }
                else
                {
                    strproviId += " select var_plan_proviid  from aoup_lcopre_plan_def ";
                    ...
                    /* if (ViewState["JVFlag"].ToString() == "Y")
                     {
                      ...
                      " and a.payterm =" + PayTerm + " and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                         whestring + whestringDevicetype +
                       " order by a.plan_name asc";
                     }
                     else
                ...
                if (planType == "AD")
                {
                    /* if (ViewState["JVFlag"].ToString() == "Y")
                     {
                         if (lblOldPlan.Text.ToString().ToUpper().Contains("FREE") == true)
                         {
                           ...
                           " where a.cityid ='" + city + "' and a.plan_type='AD'" +
                                 //" and upper(a.plan_name) like upper('" + prefixText + "%') " +
                           " and a.plan_poid not in (" + addon_poids + ")" +
                        " and  a.plan_poid2 in (" + basic_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "' " +
                        " and var_plan_freeflag='Y' " +
                          " and payterm ='" + AddOnpayterm + "' " +
                                 //" and a.plan_proviid='" + proviId + "'" +
                            " order by a.plan_name asc";
                         ...
                         else
                         {
                            ...
                            " and a.plan_poid not in (" + addon_poids + ")" +
                             " and a.plan_poid not in (" + ViewState["planoflcoshare"].ToString() + ") " +
                         " and  a.plan_poid2 in (" + basic_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "'" +
                         " and a.plan_proviid='" + proviId + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                    ...
                    if (ViewState["JVFlag"].ToString() == "Y")
                    {
                        str = " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price,  a.lco_price, a.payterm, ";
                        str += " a.cityid, a.company_code, a.insby, a.insdt,a.var_plan_devicetype,num_plan_sd_cnt,num_plan_hd_cnt,BC_PRICE, a.broad_name, a.genre_type,a.var_plan_freeflag  FROM view_lcopre_lcojvplan_fetch a ";
                        str += "  where a.cityid ='" + city + "' and a.PLAN_TYPE='" + planType + "' ";
                        str += " and a.plan_poid not in (" + addon_poids + ") and a.dasarea='" + Session["dasarea"].ToString() + "'";
                        // str += "  and var_plan_freeflag <> 'Y' ";
                        str += "  and lcocode=" + Session["lcoid"].ToString() + whestringDevicetype;
                        /*str += "  and (  addon_plantype is null ";
                        foreach (string st in addon_poidsarr)
                        {
                            str += " or INSTR(addon_plantype,'" + st + ",')>0   ";
                ...
                else if (planType == "HSP")
                {
                   ...
                   " and var_plan_freeflag='N' " +
                    ...
                    if (ViewState["JVFlag"].ToString() == "Y")
                    {
                        ...
                        str += " SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price, a.lco_price, a.payterm, ";
                        str += " a.cityid, a.company_code, a.insby, a.insdt,a.var_plan_devicetype,num_plan_sd_cnt,num_plan_hd_cnt,bc_price, a.broad_name, a.genre_type,a.var_plan_freeflag FROM VIEW_LCOJVPLAN_FETCH_ALL a ";
                        str += " where a.cityid ='" + city + "'and a.PLAN_TYPE in(" + planType + ") ";
                        str += " and a.plan_poid not in (" + hsp_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "'";
                        str += " and lcocode=" + Session["lcoid"].ToString() + whestringDevicetype;
                        str += " and jvno='" + Convert.ToString(Session["JVNO"]) + "'";// and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "' 
                        str += " union SELECT a.plan_id, a.plan_name, a.plan_type, a.plan_poid, a.deal_poid, a.product_poid, a.cust_price, a.lco_price, a.payterm, ";
                        str += " a.cityid, a.company_code, a.insby, a.insdt,a.var_plan_devicetype,num_plan_sd_cnt,num_plan_hd_cnt,bc_price, a.broad_name, a.genre_type,a.var_plan_freeflag FROM VIEW_JVPLAN_FETCH_ALL a ";
                        str += " where a.cityid ='" + city + "' and a.PLAN_TYPE in(" + planType + ")  and jvno='" + Convert.ToString(Session["JVNO"]) + "'";
                        str += " and a.plan_poid not in (" + hsp_poids + ") and a.dasarea='" + Session["dasarea"].ToString() + "'" + whestringDevicetype;
                        //str += " and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'";
                        str += " and not EXISTS (select * from VIEW_LCOJVPLAN_FETCH_ALL where plan_name=a.plan_name and plan_poid=a.plan_poid and lcocode=" + Session["lcoid"].ToString() + ")";
                        str += " )where (plAN_name not like'%NCF%' ) order by (case when plan_type='B' then 1 else 2 end) asc";
                ...
                else if (planType == "AL")
                {
                    if (ViewState["JVFlag"].ToString() == "Y")
                    {
                        str = " SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price,a.product_poid,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.BROAD_NAME, a.GENRE_TYPE,a.var_plan_freeflag " +
                                              ...
                                              " FROM view_lcopre_plan_jvfetchnew a " +
                                              " where a.plan_type='AL' and a.cityid ='" + city + "' " +
                                              " and a.plan_poid not in (" + ala_poids + ") " + whestringDevicetype +
                                              " and a.dasarea='" + Session["dasarea"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +// and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                                              " and not EXISTS (select * from  view_lcopre_lcoplan_jvfetchnew where plan_name=a.plan_name and  plan_poid=a.plan_poid and lcocode=" + Session["lcoid"].ToString() + ") " +
                                              " ) minus  " +
                                              " ( " +
                    ...
                    else
                    {
                        str = " SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price,a.product_poid,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.BROAD_NAME, a.GENRE_TYPE,a.var_plan_freeflag " +
                                       ...
                                       " union select * from ( (SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price,a.product_poid,a.var_plan_devicetype,a.num_plan_sd_cnt,a.num_plan_hd_cnt,a.BC_PRICE, a.BROAD_NAME, a.GENRE_TYPE,a.var_plan_freeflag " +
                                          " FROM view_lcopre_plan_fetchnew a " +
                                         " where a.plan_type='AL' and a.cityid ='" + city + "' " +
                                         " and a.plan_poid not in (" + ala_poids + ") " + whestringDevicetypeAl +
                                          "  and a.dasarea='" + Session["dasarea"].ToString() + "'" +// and a.payterm ='" + rdbplanpayterm.SelectedValue.ToString().Trim() + "'
                                          " and not EXISTS (select * from  view_lcopre_lcoplan_fetchnew where plan_name=a.plan_name and  plan_poid=a.plan_poid and lcocode=" + Session["lcoid"].ToString() + ") " +
                                          " ) minus  " +
                                          " ( " +
                ...
                //OracleDataReader dr = cmd.ExecuteReader();
                DataTable TblPlans = GetResult(str);
                Tblchangeplan.Rows.Clear();
                string plan_testqry_str = "";
                if (TblPlans.Rows.Count > 0)
                {
                    for (int i = 0; i < TblPlans.Rows.Count; i++)
                    {
                        /*if (dr["plan_type"].ToString() == "B")
                        {
                            Double DiscountAmount = Convert.ToDouble(ViewState["DiscountAmount"].ToString());
                        ...
                        {*/
                        Tblchangeplan.Rows.Add(TblPlans.Rows[i]["plan_name"].ToString(), Convert.ToDouble(TblPlans.Rows[i]["cust_price"]), Convert.ToDouble(TblPlans.Rows[i]["lco_price"]), 0,
                            0, TblPlans.Rows[i]["plan_poid"].ToString(), TblPlans.Rows[i]["deal_poid"].ToString(), TblPlans.Rows[i]["plan_type"].ToString(), "N");
                        //}
                        //ListItem lst = new ListItem();
                        //lst.Text = dr["plan_name"].ToString();
                        //lst.Value = dr["plan_name"].ToString();
        ...
        public void ddlChangePlanSelectindex(string planType, string payterm)
        {
            ...
            if (planType == "B")
            {
               ...
               " and a.plan_poid not in (" + basic_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "'" +
               " and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +// and a.payterm ='" + payterm + "'
                " order by a.plan_name asc";
                }
                else
                {
            ...
            else if (planType == "AL")
            {
                if (ViewState["JVFlag"].ToString() == "Y")
                {
                    str = " (SELECT a.plan_id, a.plan_name, a.cust_price, a.plan_poid, a.plan_type, a.deal_poid, a.lco_price " +
                          " FROM view_lcopre_lcoplan_JVfetchnew a " +
                          " where a.plan_type='AL' and a.cityid ='" + city + "' and upper(a.plan_name) like upper('" + search_text + "%')  " +
                          " and a.plan_poid not in (" + ala_poids + ")  and a.dasarea='" + Session["dasarea"].ToString() + "'  and a.lcocode='" + Session["lcoid"].ToString() + "' and jvno='" + Convert.ToString(Session["JVNO"]) + "'" +
                          " ) minus  " +
                          " ( " +
                          " SELECT c.num_plan_id,c.var_plan_name,c.num_plan_custprice,c.var_plan_planpoid,c.var_plan_plantype,c.var_plan_dealpoid,c.num_plan_lcoprice " +
                          " FROM aoup_lcopre_lcojvplan_def a,aoup_lcopre_plan_channel b ,aoup_lcopre_lcojvplan_def c " +
        ...
        protected void btnChangePlan_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gr in GrdchangePlan.Rows)
            {
                CheckBox rbtnchangeplanselect = (CheckBox)gr.Cells[5].FindControl("rbtnchangeplanselect");
                HiddenField hdnplanaddconfPlanPoid = (HiddenField)gr.Cells[5].FindControl("hdnplanaddconfPlanPoid");
                HiddenField hdnalacartechange = (HiddenField)gr.Cells[5].FindControl("hdnalacartechange");
                ...
                if (rbtnchangeplanselect.Checked == true)
                {
                    ...
                    if (ViewState["Planid"] != null)
                    {
                        htData["planid"] = ViewState["Newplan_Poid"].ToString();
                    }
                    else
                    {
                        htData["planid"] = null;
                    ...
                    htData.Add("in_vcid", lblVCID.Text.ToString());
                    htData.Add("in_flag", "CH");
                    htData.Add("Old_planid", ViewState["Old_Planid"].ToString());
                    htData.Add("dealpoid", ViewState["Dealid"].ToString());
                    htData.Add("packageid", ViewState["Packageid"].ToString());
                    //--- plan list for refund amount.
                    string strPlanList = "";
                    foreach (GridViewRow gvrow in grdBasicPlanDetails.Rows)
                    {
                        HiddenField hdnADPlanName = (HiddenField)gvrow.FindControl("hdnBasicPlanName");
                        HiddenField hdnADPlanPoid = (HiddenField)gvrow.FindControl("hdnBasicPlanPoid");
                        HiddenField hdnADActivation = (HiddenField)gvrow.FindControl("hdnBasicActivation");
                        HiddenField hdnADExpiry = (HiddenField)gvrow.FindControl("hdnBasicExpiry");
                        HiddenField hdnBasicPlanType = (HiddenField)gvrow.FindControl("hdnBasicPlanType");
                        if (hdnBasicPlanType.Value == "NCF")
                        {
                            strPlanList += hdnADPlanPoid.Value + "$" + hdnADExpiry.Value + "#";
                        }
                    }
                    foreach (GridViewRow gvrow in grdAddOnPlan.Rows)
                    {
                        HiddenField hdnADPlanName = (HiddenField)gvrow.FindControl("hdnADPlanName");
                        HiddenField hdnADPlanPoid = (HiddenField)gvrow.FindControl("hdnADPlanPoid");
                    ...
                    foreach (GridViewRow gvrow in grdCarte.Rows)
                    {
                        ...
                        strPlanList += hdnALPlanPoid.Value + "$" + hdnALExpiry.Value + "#";
                    }
                    ViewState["strPlanList"] = strPlanList.TrimEnd('#');
                    htData.Add("strPlanList", strPlanList.TrimEnd('#'));
                    //---
                    ...
                    {
                        htData.Add("RemaingDays", amt[0]);
                        htData.Add("RefundAmt", amt[2]);
                        htData.Add("RefundAmtlco", amt[4]);
                        htData.Add("OtherCustRefund", amt[6]);
                        htData.Add("OtherLCORefund", amt[5]);
                        setChangePopup("This will change the plan with following details.", "Are you sure you want to change?", "R", "AD", htData);
        ...
        protected void btnChangePlanConfirmation_Click(object sender, EventArgs e)
        {
            ...
            processChangeTransaction_New();

            DataRow row1 = dtFOCPlanStatus.NewRow();
            row1["PlanName"] = ViewState["NewPlanName"].ToString();
            row1["RenewStatus"] = ViewState["ErrorMessage"];
            dtFOCPlanStatus.Rows.Add(row1);
        ...
        public void testing()
        {
            ...
            if (res[0] == "9999")
            {
                ...
                if (status == true)
                {
                    ...
                    if (ViewState["OldPlanName"].ToString().Contains("BASIC SERVICE TIE") == true || ViewState["OldPlanName"].ToString().Contains("PRIME") == true)
                    {
                        string _tvType = "";
                        DataTable sortedDT = (DataTable)ViewState["vcdetail"];
                        DataTable myResultSet = sortedDT.Select("TAB_FLAG='" + hdntag.Value + "'").CopyToDataTable();
        ...
        protected void setChangePopup(string message1, string message2, string flag, string grid, Hashtable ht)
        {
            try
            {
                ...
                lblRemainingDays.Text = ht["RemaingDays"].ToString();
                lblOtherCustRefund.Text = ht["OtherCustRefund"].ToString();
                lblOtherLCORefund.Text = ht["OtherLCORefund"].ToString();
                lblConfirmNewPlan.Text = Convert.ToString(ViewState["NewPlanName"]);
                ...
                if (strPlanlist[0] == "9999")
                {
                    if (strPlanlist[1] == "Y")
                    {
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            //htData["Plan_Type"] += "B"+",";
                            //htData["autorenew"] += "N"+",";
                            dtRenew.Rows.Add(dt.Rows[i][0].ToString(), dt.Rows[i][1].ToString(), dt.Rows[i][2].ToString(), 0, dt.Rows[i][1].ToString(), "", "", dt.Rows[i][5].ToString(), dt.Rows[i][6].ToString(), htData["activation"], "N", 0, 0, 0);
                        }
                    }
                }
                else
        ...
        protected void lnkatag_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                trCustBOUQUET_ID.Visible = false;
        ...
        protected void btnRenSubmit_Click(object sender, EventArgs e)
        {
            ...
            dtRenew.Columns.Add(new DataColumn("Activation"));
            dtRenew.Columns.Add(new DataColumn("valid_upto"));
            dtRenew.Columns.Add(new DataColumn("Channel_Count", typeof(double)));
            if (grdBasicPlanDetails.Rows.Count > 0)
            {
                foreach (GridViewRow gvrow in grdBasicPlanDetails.Rows)
                {
                    ...
                    if (chk != null & chk.Checked)
                    {
                        ...
                        if (hdnBasicPlanType.Value.ToString() != "NCF")
                        {
                            ...
                            dtRenew.Rows.Add(hdnBasicPlanName.Value, hdnBasicCustPrice.Value, hdnBasicLcoPrice.Value, 0, hdnBasicActivation.Value, hdnBasicExpiry.Value, hdnChannelCount.Value);
                        }
                    }
                }
            ...
            if (grdAddOnPlan.Rows.Count > 0)
            {
                ...
                foreach (GridViewRow gvrow in grdAddOnPlan.Rows)
                {
                    ...
                    if (chk != null & chk.Checked)
                    {
                        ...
                        dtRenew.Rows.Add(hdnADPlanName.Value, hdnADCustPrice.Value, hdnADLcoPrice.Value, 0, hdnADActivation.Value, hdnADExpiry.Value, hdnChannelCount.Value);
                    }
                }
            ...
            if (grdCarte.Rows.Count > 0)
            {
                ...
                foreach (GridViewRow gvrow in grdCarte.Rows)
                {
                    ...
                    if (chk != null & chk.Checked)
                    {
                        ...
                        dtRenew.Rows.Add(hdnALPlanName.Value, hdnALCustPrice.Value, hdnALLcoPrice.Value, 0, hdnALActivation.Value, hdnALExpiry.Value, hdnChannelCount.Value);
                    }
                }
            ...
            if (strPlanlist[0] == "9999")
            {
                if (strPlanlist[1] == "Y")
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        //dtRenew.Rows.Add(dt.Rows[i][0].ToString(), dt.Rows[i][1].ToString(), dt.Rows[i][2].ToString(), 0, dt.Rows[i][1].ToString(), "", "", dt.Rows[i][5].ToString(), dt.Rows[i][6].ToString(), htData["activation"], "N");
                        dtRenew.Rows.Add(dt.Rows[i][0].ToString(), dt.Rows[i][1].ToString(), dt.Rows[i][2].ToString(), 0, "", "", 0);
                    }
                }
            }
            else
            ...
            if (dtRenew.Rows.Count > 0)
            {
                GrdAllRenewConfirm.Columns[1].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("CUST_PRICE")).Sum().ToString();
                GrdAllRenewConfirm.Columns[2].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("LCO_PRICE")).Sum().ToString();
                GrdAllRenewConfirm.Columns[3].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("Channel_Count")).Sum().ToString();
        ...
        protected void BtnAutoRenewAll_Click(object sender, EventArgs e)
        {
            ...
            if (strPlanlist[0] == "9999")
            {
                ...
                {
                    DataTable dt = new DataTable();
                    dt = objPlan.getNCFPlanDetails(Session["lco_username"].ToString(), strPlanlist[2].ToString(), ViewState["JVFlag"].ToString(), ViewState["cityid"].ToString(), Session["dasarea"].ToString(), Convert.ToString(Session["operator_id"]));
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
        ...
        protected void btnModifyCust_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (apiResponse != "")
                {
                    ...
                    str = "select SUBSTR(city_code,0,2)||'|'||city_code||'|'||city_code areacode  from geo_master ";
        ...
        protected void processTransactionAutoRenew(string plan_poid, string Expdate, string Status)
        {
            try
            {
                ...
                string reason_id = "";
                string reason_text = "";
                DateTime curetime = DateTime.Now;
                string currentdate = curetime.ToString("dd-MMM-yyyy").Trim();
 ...
 if (ViewState["date"].ToString() != currentdate)
                    {
                        ht.Add("date", ViewState["date"].ToString());
                    }
                    else
                    {
                        ViewState["date"] = "";
        ...
        protected void btnAutoRenewal_Click(object sender, EventArgs e)
        {
            ...
            txtDate.Text = dtime.ToString("dd-MMM-yyyy").Trim();
        ...
        protected void btnFaultyConf_Click(object sender, EventArgs e)
        {
            ...
            //obj3.GetPlanTo_Swap(Session["username"].ToString(), txtfaultySTBID.Text, txtfaultyNewSTBID.Text, Session["SwapWise"].ToString(), out OutStatus);
            DEVICE_ID = txtfaultyNewSTBID.Text.Trim();
            FLD_FLAGS = "121";
            reqcode = "40";
            req = Session["lco_username"].ToString() + "$" + DEVICE_ID + "$" + FLD_FLAGS;
            ...
            if (final_obrm_status[0].ToString() == "0")
            {
                ...
                if (APISOURCE != Session["lco_username"].ToString())
                {
                    OutStatus = "100$Device does not belong to this LCO";
                }

                else if (DELIVERY_STATUS == "2")
                {
                    OutStatus = "102$This Device is undelivered. It can not be activated";
                }

                else if (DELIVERY_STATUS == "3")
                {
                    OutStatus = "103$This Device is Faulty. It can not be activated";
                }

                else if (DELIVERY_STATUS == "4")
                {
                    OutStatus = "104$This Device is Lost in Transit. It can not be activated";
                }
                else if (APISOURCE == Session["lco_username"].ToString())
                {
                    OutStatus = "9999$Device does not belong to this LCO";
                }
            }
            else
            {
                OutStatus = "105$Error while calling Obrm OP Search";
            }
            //-
        ...
        protected void btnShowCancel_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dtRenew = new DataTable();
                ...
                foreach (GridViewRow gvrow in grdBulkCancel.Rows)
                {
                    ...
                    if (seleced.Checked == true)
                    {
                        ...
                        htData["autorenew"] = "N";
                        htData["plantypevalue"] = hdnPlanType.Value;
                        htData["ChannelCount"] = hdnChannelCount.Value;
                        grdMultCancelPlan.DataSource = null;
                        grdMultCancelPlan.DataBind();
                        ...
                        else
                        {
                            ...
                            refund_amt = conResult_arr[1];
                            days_left = conResult_arr[0];
                            try
                            {
                                refund_lcoamt = conResult_arr[2];
                            }
                            catch
                            {
                                refund_lcoamt = "Rs.0";
                        ...
                        dtRenew.Rows.Add(htData["planname"], htData["custprice"], htData["lcoprice"], 0, htData["custprice"], htData["activation"], htData["expiry"], htData["planpoid"], htData["dealpoid"], htData["activation"], "N", refund_amt, days_left, refund_lcoamt, htData["packageid"], htData["purchasepoid"], htData["ChannelCount"]);

                    }
                }
                if (dtRenew.Rows.Count > 0)
                {
                    grdMultCancelPlan.Columns[1].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("CUST_PRICE")).Sum().ToString();
                    grdMultCancelPlan.Columns[2].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("refund_lcoamt")).Sum().ToString();
                    grdMultCancelPlan.Columns[3].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("refund_amt")).Sum().ToString();
                    grdMultCancelPlan.DataSource = dtRenew;
                    grdMultCancelPlan.DataBind();
                    Label158.Text = "This will cancel the plan with following details.";
                    Label161.Text = "Are you sure you want to cancel?";
                    mpeMultcnlconf.Show();
                }
                else
                {
                    //
                    popBulkCancel.Show();
                    lblmutlcnlmsg.Text = "Please Select Plan ...";
                }
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string[] service_arr = cust_services.Split('^');
                int k = 0;
                List<Hashtable> htList1 = new List<Hashtable>();
                List<Hashtable> htList2 = new List<Hashtable>();
                ...
                foreach (GridViewRow gvrow in grdMultCancelPlan.Rows)
                {
                    Hashtable htData = new Hashtable();
                    HiddenField hdnBasicPlanName = (HiddenField)gvrow.FindControl("hdnPlanName");
                    HiddenField hdnBasicPlanPoid = (HiddenField)gvrow.FindControl("hdnPlanPoid");
                    ...
                    else
                    {
                        ...
                        //add htData into list1
                        //add ht into list2
                        //add processTransaction_cancellation parameters into list3
                        DataRow row2 = dtPlanStatus.NewRow();
        ...
        //-- button Rights --19.03.2019 BY RP
        protected void FillLcoDetails()
        {
            ...
            try
            {
                ...
                str = " select var_access_add,var_access_renew,var_access_change,var_access_cancel,var_access_discount,var_access_retrack,var_access_custmodify,var_access_stbswap,var_access_autorenew,var_access_Deactivate,var_access_Terminate,var_access_FOCPack from AOUP_LCOPRE_ACCESS_CONTROL where var_access_username='" + Session["username"].ToString() + "'";
                DataTable tbllco = GetResult(str);
                if (tbllco.Rows.Count > 0)
                {
                    ViewState["Add"] = tbllco.Rows[0]["var_access_add"].ToString();
                    ViewState["renew"] = tbllco.Rows[0]["var_access_renew"].ToString();
                    ViewState["change"] = tbllco.Rows[0]["var_access_change"].ToString();
                    ViewState["cancel"] = tbllco.Rows[0]["var_access_cancel"].ToString();
                    ViewState["discount"] = tbllco.Rows[0]["var_access_discount"].ToString();
                    ViewState["retrack"] = tbllco.Rows[0]["var_access_retrack"].ToString();
                    ViewState["custmodify"] = tbllco.Rows[0]["var_access_custmodify"].ToString();
                    ViewState["stbswap"] = tbllco.Rows[0]["var_access_stbswap"].ToString();
                    ViewState["autorenew"] = tbllco.Rows[0]["var_access_autorenew"].ToString();
                    ViewState["Deactivate"] = tbllco.Rows[0]["var_access_Deactivate"].ToString();
                    ViewState["Terminate"] = tbllco.Rows[0]["var_access_Terminate"].ToString();
                    ViewState["FOCPack"] = tbllco.Rows[0]["var_access_FOCPack"].ToString();
                }
                else
                {
                    ViewState["Add"] = "Y";
                    ...
                    ViewState["change"] = "Y";
                    ViewState["cancel"] = "Y";
                    ViewState["discount"] = "Y";
                    ViewState["retrack"] = "Y";
                    ViewState["custmodify"] = "Y";
                    ViewState["stbswap"] = "Y";
                    ViewState["autorenew"] = "Y";
                    ViewState["Deactivate"] = "Y";
                    ViewState["Terminate"] = "Y";
                    ViewState["FOCPack"] = "Y";
                }
            }
            catch (Exception ex)
        ...
        protected void BtnAlign_Click(object sender, EventArgs e)
        {
            ...
            string apiResponse2 = "0$Success";//callAPI(response_params2, "39");
            string obrm_orderid = "";
            string[] GetAPIresponse = apiResponse2.Split('$');
            if (GetAPIresponse[0] == "0")
            {
        ...
        protected void lnkBAlign_Click(object sender, EventArgs e)
        {
            DataTable sortedDT = (DataTable)ViewState["vcdetail"];
            DataTable myResultSet = sortedDT.Select("TAB_FLAG='" + hdntag.Value + "'").CopyToDataTable();
            string stb_no = myResultSet.Rows[0]["STB_NO"].ToString();
            ...
            selected_service_str = selected_service_str.Replace("|", "$");
            Cls_Business_TxnAssignPlan objPlan = new Cls_Business_TxnAssignPlan();
            string strNCFPlanList = objPlan.AlignPlan(Session["lco_username"].ToString(), selected_service_str, ViewState["cityid"].ToString(), ViewState["customer_no"].ToString(), Session["operator_id"].ToString(), "", "ALIGN", vc_id);
            string[] strPlanlist = strNCFPlanList.Split('$');


            if (strPlanlist[0] == "9999")
            {
                string[] strPlanDetails = strPlanlist[1].Split('#');

                DataTable dtRenew = new DataTable();
                dtRenew.Columns.Add(new DataColumn("PLAN_NAME"));
                dtRenew.Columns.Add(new DataColumn("CREDIT_AMT", typeof(double)));
                dtRenew.Columns.Add(new DataColumn("DEBIT_AMT", typeof(double)));

                for (int i = 0; i < strPlanDetails.Length; i++)
                {
                    //DataRow r1 = dtRenew.NewRow();
                    string[] strPlanDetail = strPlanDetails[i].Split('~');
                    dtRenew.Rows.Add(strPlanDetail[0], strPlanDetail[1], strPlanDetail[2]);
                }

                if (dtRenew.Rows.Count > 0)
                {
                    GrdAlignConfirm.Columns[1].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("CREDIT_AMT")).Sum().ToString();
                    GrdAlignConfirm.Columns[2].FooterText = dtRenew.AsEnumerable().Select(x => x.Field<Double>("DEBIT_AMT")).Sum().ToString();
                    GrdAlignConfirm.DataSource = dtRenew;
                    GrdAlignConfirm.DataBind();
                    popupAlign.Show();
                    PnlAllRenewConfirm.Visible = true;
                }
            ...
            {
                popupAlign.Hide();
                msgboxstr("Failed in calcutaion of Credit/Debit  ...");
