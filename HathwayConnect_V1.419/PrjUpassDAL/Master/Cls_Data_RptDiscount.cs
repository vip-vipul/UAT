...
{
   public class Cls_Data_RptDiscount
    {
        public DataTable GetTransations(string whereClauseStr, string username)
        {
            try
            {
                ...
                StrQry = "SELECT * FROM view_lcopre_discount_det " +                                
            ...
            catch (Exception ex)
            {
                ...
                objSecurity.InsertIntoDb(username, ex.Message.ToString(), "Cls_Data_RptDiscount.cs");
                return null;
            }
        }
    }
